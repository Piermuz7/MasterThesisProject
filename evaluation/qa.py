title_queries = [
    ...
    "Which project was Andrea Polini involved in?",
    "What were the participants involved in the project named 'BIM-based holistic tools for Energy-driven Renovation of existing Residences'?",
    "What are the start date and end date of the project named 'BIM-based holistic tools for Energy-driven Renovation of existing Residences'?",
    "What is the postal address of university of Camerino?",
    "What are the postal addresses of FACHHOCHSCHULE NORDWESTSCHWEIZ?",
    "What are the start date and end date of the project named 'Adaptive Multimodal Interfaces to Assist Disabled People in Daily Activities'?",
    "Who is Emanuela Merelli?",
    "Where Emanuela Merelli is affiliated with?",
    "What projects has the University of Camerino been involved in?"
    ""
]
...
The project involved collaboration among several prestigious institutions and researchers:
    ...
    "Andrea Polini was involved in the project titled \"Large Scale Choreographies for the Future Internet\"",
    """
    •HERIOT-WATT UNIVERSITY - Riccarton, EH14 4AS Edinburgh, UK
	•UBITECH LIMITED - 26 NIKOU & DESPINAS PATTCHI, 3071 Limassol, CY
	•NOVITECH AS - MOYZESOVA 58, 040 01 KOSICE, SK
	•XYLEM SCIENCE AND TECHNOLOGY MANAGEMENT GMBH - FLORAGASSE 7, 5. STOCK, 1040 WIEN, AT
	•MERIT CONSULTING HOUSE - OLOKRIROMENES SYMVOULEFTIKES IPIRESIES EPIXEIRISEON IDIOTIKI KEFALAIOUXIKI ETAIREIA - DOUKISSIS PLAKENTIAS 3, 152 34 CHALANDRI, EL
	•MERIT CONSULTING HOUSE - AVENUE DE FRE 265, 1180 UCCLE, BE
	•FERROVIAL CONSTRUCCION SA - CALLE RIBERA DEL LOIRA 42, 28042 Madrid, ES
	•THE UNIVERSITY OF EDINBURGH - OLD COLLEGE, SOUTH BRIDGE, EH8 9YL Edinburgh, UK
	•BOC ASSET MANAGEMENT GMBH - OPERNGASSE 208, 1040 WIEN, AT
	...
	•HYPERTECH (CHAIPERTEK) ANONYMOS VIOMICHANIKI EMPORIKI ETAIREIA PLIROFORIKIS KAI NEON TECHNOLOGION - 32 PERIKLEOUS STREET, 15232 CHALANDRI ATHINA, EL
	•ANONYMOS ETAIREIA KATASKEVON-TECHNIKON ERGON, EMPORIKON, VIOMICHANIKONKAI NAUTILIAKON EPICHEIRISEON KON’KAT - IRODOY ATTOKOY 12A, 15124 MAROUSI, EL
	•UNIVERSITY OF PELOPONNESE - STAVROU 28 KAI KARYOTAKI 28, 221 00 TRIPOLIS, EL
	•BUDIMEX SPOLKA AKCYJNA - SIEDMIOGRODZKA 9, 01 204 WARSZAWA, PL
	•EXERGY LTD - PUMA WAY THE TECHNOCENTRE COVENTRY UNIVERSITY TECHNOLOGY PARK, CV1 2TT COVENTRY, UK
	•GLASSUP SRL - VIA GANACETO 95, 41121 MODENA, IT
    """,
    "The project named \"BIM-based holistic tools for Energy-driven Renovation of existing Residences\" started on January 1, 2019, and ended on September 30, 2022.",
    "The postal addresses associated with the University of Camerino are: Piazza Cavour 19F, 62032 Camerino, IT; Corso Vittorio Emanuele II, 17, 62032 Camerino, IT"
    "The postal address of FACHHOCHSCHULE NORDWESTSCHWEIZ is: BAHNHOFSTRASSE 6, 5210 Windisch, CH.",
    "The project named 'Adaptive Multimodal Interfaces to Assist Disabled People in Daily Activities' started on February 1, 2015, and ended on May 31, 2018.",
    "Emanuela Merelli, affiliated with Università degli Studi di Camerino, is involved in the project “Topology driven methods for complex systems” and can be contacted via telephone at +390737402567 or fax at +390737402561."
    "Emanuela Merelli is affiliated with Università degli Studi di Camerino.",
    """
    The University of Camerino has been involved in the following projects:
    ...
    •Nanoscale energy management for powering ICT devices
...
potential_collaborators_queries = [
    """
        ...
        Which persons could be potential collaborators for the specified project description and objectives? List  the name of the persons and their affiliation organisations
        """,
    """
    Project Description:
    ...
    """,
    """
    Identity potential collaborators for the following project.
    What could be the contribution of the potential collaborators to the project?
    ...
    """,
    """
    Identity potential collaborators for the following project details.
    ...
    """,
    """
    Suggest potential collaborators for the following project details.
    ...
    """,
    """
    Recommend potential collaborators for the following project details.
...
potential_collaborators_ground_truths = [
    """
    •Maurizio Frezzotti
    Organisation: E-GEOS SPA, LOCALITA TERLECCHIE, 75100 Matera, IT
    Project title: Traffic- Health- Environment. Intelligent Solutions Sustaining Urban Economies
    Research areas: Geospatial intelligence, urban traffic management, environmental monitoring
    
    •Peter Fletcher
    Organisation: INFOTERRA LIMITED, Atlas House, 41 - Wembley Road, LE3 1UT LEICESTER, UK
    Project title: Traffic- Health- Environment. Intelligent Solutions Sustaining Urban Economies
    Research areas: Digital transformations, product development, climate applications

    •Fabrizio Spallone    
    Organisation: AGENZIA REGIONALE PER LO SVILUPPO DEL MOLISE - SVILUPPO ITALIA MOLISE SPA, VIA CRISPI 1, 86100 Campobasso, IT
    Project title: Traffic- Health- Environment. Intelligent Solutions Sustaining Urban Economies
    Research areas: Local development, territorial marketing, international projects
    
    •Eric Goodyer
    Organisation: DE MONTFORT UNIVERSITY, THE GATEWAY, LE1 9BH LEICESTER, UK
    Project title: Traffic- Health- Environment. Intelligent Solutions Sustaining Urban Economies
    Research areas: Intelligent transport systems, computational modeling, technology integration
    
    •Frederique Lacroix
    Organisation: AEROSPACE VALLEY, 3 RUE TARFAYA CS 64403, 31400 Toulouse, FR
    Project title: Traffic- Health- Environment. Intelligent Solutions Sustaining Urban Economies
    Research areas: Aerospace finance, administrative management, project coordination
    
    •Agnieszka Milkowska
    Organisation: INTERGRAPH POLSKA SP ZOO, UL. DOMANIEWSKA 52, 02-672 Warszawa, PL
    Project title: Traffic- Health- Environment. Intelligent Solutions Sustaining Urban Economies
    Research areas: Geospatial analysis, urban planning, data management
    
    •Tomasz Ważbiński
    Organisation: WOJEWODZTWO MAZOWIECKIE, ul. Jagiellonska 26, 03-719 Warsaw, PL
    Project title: Traffic- Health- Environment. Intelligent Solutions Sustaining Urban Economies
    Research areas: European funds management, regional development, public administration
    
    •Stephen Dibnah
    Organisation: LEICESTER CITY COUNCIL, City Hall 115 Charles Street, LE1 1FZ LEICESTER, UK
    Project title: Traffic- Health- Environment. Intelligent Solutions Sustaining Urban Economies
    Research areas: Sustainable economic growth, urban development, public sector consultancy
    
    •Albina Moscicka
    Organisation: INSTYTUT GEODEZJI I KARTOGRAFII, UL ZYGMUNTA MODZELEWSKIEGO 27, 02 679 WARSZAWA, PL
    Project title: Traffic- Health- Environment. Intelligent Solutions Sustaining Urban Economies
    Research areas: Geodesy, cartography, geoinformation systems
    
    •Gherardo Chirici
    Organisation: UNIVERSITA DEGLI STUDI DEL MOLISE, Via De Sanctis Ioc. Vazzieri, 86100 Campobasso, IT
    Project title: Traffic- Health- Environment. Intelligent Solutions Sustaining Urban Economies
    Research areas: Forest inventory, remote sensing, ecological planning
    
    •Marie Adams
    Organisation: UNIVERSITY OF LEICESTER, UNIVERSITY ROAD, LE1 7RH LEICESTER, UK
    Project title: Traffic- Health- Environment. Intelligent Solutions Sustaining Urban Economies
    Research areas: Research development, partnership management, international collaboration
    
    •Angelique Floot
    Organisation: TECHNOLUTION BV, BURGERMEESTER JAMESSINGEL 1, 2803 WV Gouda, NL
    Project title: Common building blocks for ITS test beds and field operational tests
    Research areas: Financial management, technology integration, intelligent transport systems
    
    •Jurgen Rataj
    Organisation: DEUTSCHES ZENTRUM FUR LUFT - UND RAUMFAHRT EV, LINDER HOHE, 51147 KOLN, DE
    Project title: Common building blocks for ITS test beds and field operational tests
    Research areas: Transportation research, aerospace technology, intelligent transport systems
    
    •Paul Potters
    Organisation: STICHTING CONNEKT, EZELSVELDLAAN 59, 2611 RV DELFT, NL
    Project title: Common building blocks for ITS test beds and field operational tests
    Research areas: Cooperative connected automated mobility, traffic management, intelligent transport systems
    
    •Erik Kampenhøy
    Organisation: STIFTELSEN SINTEF, STRINDVEIEN 4, 7034 Trondheim, NO
    Project title: Common building blocks for ITS test beds and field operational tests
    Research areas: Embedded networks, submarine surveillance, intelligent transport systems
    
    •Benoit Augarde
    Organisation: ASSOCIATION POUR LE DEVELOPPEMENT DES TECHNIQUES DE TRANSPORT D ENVIRONNEMENT ET DE CIRCULATION, AVENUE DE VERSAILLES 51BIS, 75016 PARIS, FR
    Project title: Common building blocks for ITS test beds and field operational tests
    Research areas: Transport techniques development, environmental circulation, intelligent transport systems
    
    •Limpens Kris
    Organisation: NXP SEMICONDUCTORS BELGIUM NV, INTERLEUVENLAAN 80, 3001 Leuven, BE
    Project title: Common building blocks for ITS test beds and field operational tests
    Research areas: Semiconductor technology, intelligent transport systems, project management
    
    •Evert Mol
    Organisation: NEDERLANDSE ORGANISATIE VOOR TOEGEPAST NATUURWETENSCHAPPELIJK ONDERZOEK TNO, ANNA VAN BUERENPLEIN 1, 2595 DA DEN HAAG, NL
    Project title: Common building blocks for ITS test beds and field operational tests
    Research areas: Applied scientific research, intelligent transport systems, environmental restoration
    
    •Knut Evensen
    Organisation: Q-Free ASA, THONNING OWESENSG 35 C, 7044 TRONDHEIM, NO
    Project title: Common building blocks for ITS test beds and field operational tests
    Research areas: Telematics, intelligent transport systems, technology innovation
    
    •Philip Taillieu
    Organisation: TC-MATIX BVBA, Technologiepark 12 B, 9052 GENT, BE
    Project title: Common building blocks for ITS test beds and field operational tests
    Research areas: ICT applications in mobility, intelligent transport systems, project management
    
    •Mireille Gravier Bardet
    Organisation: INSTITUT NATIONAL DE RECHERCHE SUR LES TRANSPORTS ET LEUR SECURITE, Avenue du General Malleret-Joinville 2, 94114 ARCUEIL, FR
    Project title: Common building blocks for ITS test beds and field operational tests
    Research areas: Transport safety research, intelligent transport systems, project coordination
    
    •Peter Van Der Perre
    Organisation: TELEMATICS INCUBATOR, KOLONEL BOURGSTRAAT 153B, 1140 BRUSSEL, BE
    Project title: Common building blocks for ITS test beds and field operational tests
    Research areas: Telematics, intelligent transport systems, project management
    
    •Ivar Christiansen
    Organisation: ITS NORGE-NORSK FORENING FOR MULTIMODALE INTELLIGENTE TRANSPORT SYSTEMER OG TJENESTER - ITS NORWAY, DRONNING MAUDS GATE 15, 0250 Oslo, NO
    Project title: Common building blocks for ITS test beds and field operational tests
    Research areas: Multimodal intelligent transport systems, project management, technology integration
    
    •Christine Van Houtven
    Organisation: INTERUNIVERSITAIR MICRO-ELECTRONICA CENTRUM, KAPELDREEF 75, 3001 Heverlee, BE
    Project title: Common building blocks for ITS test beds and field operational tests
    Research areas: Micro-electronics, intelligent transport systems, public funded projects
    
    •Wendy Ruys
    Organisation: IMINDS VZW, GASTON CROMMENLAAN 8/102, 9050 GENT, BE
    Project title: Common building blocks for ITS test beds and field operational tests
    Research areas: Public affairs, intelligent transport systems, project management
    
    •Bernd E. Gottselig
    Organisation: FORD-WERKE GMBH, HENRY FORD STRASSE 1, 50735 KOLN, DE
    Project title: Priorities for Road Safety Research in Europe
    Research areas: Automotive safety, road safety research, global safety regulations
    
    •Jan Olsson
    Organisation: AUTOLIV DEVELOPMENT AB, WALLENTINSVAGEN 22, 447 83 VARGARDA, SE
    Project title: Priorities for Road Safety Research in Europe
    Research areas: Automotive safety, biomechanics, safety solutions
    
    •Philippe Vezin
    Organisation: RESEAU POUR LA SECURITE INTEGREE ASSOCIATION, AVENUE FRANCOIS MITTERRAND 25, 69500 BRON, FR
    Project title: Priorities for Road Safety Research in Europe
    Research areas: Road safety, simulation tools, protection systems
    
    •Christina Kolbe
    Organisation: ROBERT BOSCH GMBH, ROBERT-BOSCH-PLATZ 1, 70839 GERLINGEN-SCHILLERHOEHE, DE
    Project title: Priorities for Road Safety Research in Europe
    Research areas: Automotive safety, intelligent transport systems, simulation methodologies
    
    •Peter Urban
    Organisation: FKA GMBH, STEINBACHSTRASSE 7, 52074 Aachen, DE
    Project title: Priorities for Road Safety Research in Europe
    Research areas: Automotive engineering, road safety research, intelligent transport systems
    
    •Wolfgang Schoenlen
    Organisation: MERCEDES-BENZ GROUP AG, MERCEDESSTRASSE 120, 70372 Stuttgart, DE
    Project title: Priorities for Road Safety Research in Europe
    Research areas: Automotive safety, intelligent transport systems, global safety regulations
    ...
    Organisation: EUROPEAN UNION ROAD FEDERATION, PLACE STEPHANIE 6B, 1050 BRUXELLES, BE
    Project title: Priorities for Road Safety Research in Europe
    Research areas: Road asset management, road safety research, public policy
    
    •Daniel Selin
    Organisation: CHALMERS TEKNISKA HOGSKOLA AB, -, 412 96 GOTEBORG, SE
    Project title: Priorities for Road Safety Research in Europe
    Research areas: Material development, automotive safety, intelligent transport systems
    
    •Rayns Mark
    Organisation: LOUGHBOROUGH UNIVERSITY, ASHBY ROAD, LE11 3TU LOUGHBOROUGH, UK
    Project title: Priorities for Road Safety Research in Europe
    Research areas: Road safety research, intelligent transport systems, economic impact analysis
    """,
    """
    •Benno Pichlmaier
    Organisation: AGCO GMBH, JOHANN GEORG FENDT STR 4, 87616 MARKTOBERDORF, DE
    Project title: Sustainable Manufacturing through Advanced Robotics Training in Europe
    Research areas: Artificial intelligence, autonomous applications in agriculture, global technology & innovation
    
    •Dirk Pensky
    Organisation: FESTO DIDACTIC GMBH & CO KG, RECHBERGSTRASSE 3, 73770 DENKENDORF, DE
    Project title: Sustainable Manufacturing through Advanced Robotics Training in Europe
    Research areas: 3-D graphical simulation of manufacturing systems, mobile robotics in education, cloud-based robotics control
    
    •Simona Ventriglia
    Organisation: FONDAZIONE ISTITUTO ITALIANO DI TECNOLOGIA, VIA MOREGO 30, 16163 GENOVA, IT
    Project title: Sustainable Manufacturing through Advanced Robotics Training in Europe
    Research areas: Research management, project coordination, advanced robotics
    
    •Joanne Watson
    Organisation: THE UNIVERSITY OF SHEFFIELD, FIRTH COURT WESTERN BANK, S10 2TN SHEFFIELD, UK
    Project title: Sustainable Manufacturing through Advanced Robotics Training in Europe
    Research areas: Supported decision making, intellectual disability, proteomics workflow
    
    •Paolo Dario
    Organisation: SCUOLA SUPERIORE DI STUDI UNIVERSITARI E DI PERFEZIONAMENTO S ANNA, PIAZZA MARTIRI DELLA LIBERTA 33, 56127 Pisa, IT
    Project title: Sustainable Manufacturing through Advanced Robotics Training in Europe
    Research areas: Robotics, biorobotics, artificial intelligence
    
    •Linda Kelly
    Organisation: THE UNIVERSITY OF SALFORD, THE CRESCENT 43, M5 4WT SALFORD, UK
    Project title: Sustainable Manufacturing through Advanced Robotics Training in Europe
    Research areas: Environmental research informatics, business school research, research contracts & monitoring
    
    •Rolf Pfeifer
    Organisation: University of Zurich, RAMISTRASSE 71, 8006 ZURICH, CH
    Project title: Sustainable Manufacturing through Advanced Robotics Training in Europe
    Research areas: Embodied cognition, biorobotics, soft robotics, artificial evolution
    
    •Daniel Cuiñas
    Organisation: CENTRE CIM FUNDACIO PRIVADA, Carrer Llorens i Artigas 12, 08028 Barcelona, ES
    Project title: Sustainable Manufacturing Adaptive Services with Cloud Architectures for Enterprises
    Research areas: Structural simulations, numerical methods, nonlinear dynamics
    
    •Donald Lack
    Organisation: INENCO GROUP LIMITED, ST ANDREWS ROAD NORTH PETROS HOUSE, FY8 2NF LYTHAM ST ANNES, UK
    Project title: Sustainable Manufacturing Adaptive Services with Cloud Architectures for Enterprises
    Research areas: Energy consumption improvement, energy consultancy, primary research on energy managers
    
    •Magnus Holm
    Organisation: HOGSKOLAN I SKOVDE, HOGSKOLEVAGEN 1, 54 128 SKOVDE, SE
    Project title: Sustainable Manufacturing Adaptive Services with Cloud Architectures for Enterprises
    Research areas: Decision support for shop-floor operators, virtual commissioning, knowledge transfer
    """,
    """
    •Angela Capri
    Organisation: INNOVA BIC - BUSINESS INNOVATION CENTRE SRL, Via Consolato del Mare 41, 98122 MESSINA, IT
    Project title: Empowering Trans-Mediterranean Renewable Energy Research Alliance for Europe 2020 challenges
    Research areas: Hydrogen production, renewable energy technologies, cross-sectoral innovation
    Contribution: Angela Capri's expertise in hydrogen production and renewable energy technologies can significantly contribute to the project's objectives of developing disruptive renewable energy technologies and direct renewable hydrogen production.
    
    •Elodie Hervio
    Organisation: UNIVERSITE DE NANTES, QUAI DE TOURVILLE 1, 44035 NANTES CEDEX 1, FR
    Project title: Empowering Trans-Mediterranean Renewable Energy Research Alliance for Europe 2020 challenges
    Research areas: Marine biodiversity, ecological restoration, environmental impact assessment
    Contribution: Elodie Hervio's background in marine biodiversity and ecological restoration can help address the project's environmental impact and resource efficiency objectives.
    
    •Paola Mazzucchelli
    Organisation: EUREC EESV, PLACE DU CHAMPS DE MARS 2, 1050 BRUXELLES, BE
    Project title: Empowering Trans-Mediterranean Renewable Energy Research Alliance for Europe 2020 challenges
    Research areas: Renewable energy research, policy alignment, cross-sectoral innovation
    Contribution: Paola Mazzucchelli's experience in renewable energy research and policy alignment can aid in ensuring the project's solutions align with regulatory frameworks and facilitate seamless integration into the EU’s energy infrastructure.
    
    •Haluk Gorgun
    Organisation: YILDIZ TECHNICAL UNIVERSITY, BARBAROS BULVARI YILDIZ KAMPUS, 34349 ISTANBUL, TR
    Project title: Empowering Trans-Mediterranean Renewable Energy Research Alliance for Europe 2020 challenges
    Research areas: Electrochemical hydrogen pumps, hybrid electric vehicles, renewable energy systems
    Contribution: Haluk Gorgun's expertise in electrochemical hydrogen pumps and hybrid electric vehicles can contribute to the project's objectives of innovating in renewable hydrogen production and hybrid energy generation.
    
    •Hassan Hamdi
    Organisation: UNIVERSITE CADI AYYAD, BOULEVARD ABDELKARIM KHATTABI, 40 000 MARRAKECH, MA
    Project title: Empowering Trans-Mediterranean Renewable Energy Research Alliance for Europe 2020 challenges
    Research areas: Energy efficiency, valorization of waste and biomass, sustainable development
    Contribution: Hassan Hamdi's research in energy efficiency and sustainable development can help improve resource efficiency and minimize the environmental impact of renewable energy technologies.
    
    •Robert Sanders
    Organisation: EUROPEAN BUSINESS AND INNOVATION CENTRE NETWORK AISBL, AVENUE DE TERVUREN 168/25, 1150 BRUSSEL, BE
    Project title: Empowering Trans-Mediterranean Renewable Energy Research Alliance for Europe 2020 challenges
    Research areas: Business incubation, innovation ecosystems, sustainable economic development
    Contribution: Robert Sanders' experience in building innovation ecosystems and supporting business incubation can enhance the project's cross-sectoral knowledge transfer and public and industry adoption.
    
    •Silvia Sarria Sánchez
    Organisation: MADRID NETWORK ASOCIACION, PASEO DE LA CASTELLANA 91 4 PLANTA, 28046 MADRID, ES
    Project title: Empowering Trans-Mediterranean Renewable Energy Research Alliance for Europe 2020 challenges
    Research areas: Renewable energy policy, innovation management, cross-sectoral collaboration
    Contribution: Silvia Sarria Sánchez's expertise in renewable energy policy and innovation management can support the project's objectives of aligning with regulatory frameworks and leveraging cross-sector knowledge transfer.
    
    •Maher Abu Eid
    Organisation: AN-NAJAH NATIONAL UNIVERSITY, OMAR IBN KHATAB STREET, N/A NABLUS, PS
    Project title: Empowering Trans-Mediterranean Renewable Energy Research Alliance for Europe 2020 challenges
    Research areas: Renewable energy systems, academic research, technology transfer
    Contribution: Maher Abu Eid's background in renewable energy systems and technology transfer can contribute to the project's objectives of validating technological feasibility and ensuring long-term knowledge retention.
    
    •Olga-Stamatina Parissis
    Organisation: CENTRE FOR RENEWABLE ENERGY SOURCES AND SAVING FONDATION, MARATHONOS 19TH KM, 19009 PIKERMI, EL
    Project title: Empowering Trans-Mediterranean Renewable Energy Research Alliance for Europe 2020 challenges
    Research areas: Renewable energy sources, energy information systems, feasibility studies
    Contribution: Olga-Stamatina Parissis' expertise in renewable energy sources and feasibility studies can help assess the environmental, social, and economic benefits of the project's renewable energy solutions.
    
    •Agatino Nicita
    Organisation: CONSIGLIO NAZIONALE DELLE RICERCHE, PIAZZALE ALDO MORO 7, 00185 ROMA, IT
    Project title: Empowering Trans-Mediterranean Renewable Energy Research Alliance for Europe 2020 challenges
    Research areas: Socio-economic impact studies, energy technologies, scientific documentation
    """,
    """
    •Katja Boettcher
    Organisation: TECHNISCHE UNIVERSITAET DRESDEN, HELMHOLTZSTRASSE 10, 01069 Dresden, DE
    Project title: Graphene-Based Revolutions in ICT And Beyond
    Research areas: Joint Research Activities, European Project Center, Horizon Europe
    
    •Virginia Morales
    Organisation: GRUPO ANTOLIN-INGENIERIA SA, CARRETERA MADRID IRUN KM 244 8, 09007 Burgos, ES
    Project title: Graphene-Based Revolutions in ICT And Beyond
    Research areas: Carbon nanofibers, polymer composites, automotive interior components
    
    •Sara Pittaluga
    Organisation: FONDAZIONE ISTITUTO ITALIANO DI TECNOLOGIA, VIA MOREGO 30, 16163 GENOVA, IT
    Project title: Graphene-Based Revolutions in ICT And Beyond
    Research areas: Neuro-Plasmonics, label-free nanoscopy, conference interpreting
    
    •Deirdre Savage
    Organisation: THE PROVOST, FELLOWS, FOUNDATION SCHOLARS & THE OTHER MEMBERS OF BOARD, OF THE COLLEGE OF THE HOLY & UNDIVIDED TRINITY OF QUEEN ELIZABETH NEAR DUBLIN, COLLEGE GREEN TRINITY COLLEGE, D02 CX56 DUBLIN 2, IE
    Project title: Graphene-Based Revolutions in ICT And Beyond
    Research areas: Comparative theology, cultural trauma, social practice
    
    •Krisztina Szakolczal
    Organisation: ENERGIATUDOMANYI KUTATOKOZPONT, KONKOLY THEGE MIKLOS UT 29-33, 1121 Budapest, HU
    Project title: Graphene-Based Revolutions in ICT And Beyond
    Research areas: Hypoallergenic implant materials, personalized medicine
    
    •Philippe CAVELIER
    Organisation: CENTRE NATIONAL DE LA RECHERCHE SCIENTIFIQUE CNRS, RUE MICHEL ANGE 3, 75794 Paris, FR
    Project title: Graphene-Based Revolutions in ICT And Beyond
    Research areas: Geon-type solutions in Einstein's theory of Gravitation, talent agents in the American film industry
    
    •Franziska Müller
    Organisation: FRIEDRICH-ALEXANDER-UNIVERSITAET ERLANGEN-NUERNBERG, SCHLOSSPLATZ 4, 91054 Erlangen, DE
    Project title: Graphene-Based Revolutions in ICT And Beyond
    Research areas: Molecular materials, sustainability, psychiatry
    
    •Peter Olanders
    Organisation: ERICSSON AB, TORSHAMNSGATAN 23, 164 80 Stockholm, SE
    Project title: Graphene-Based Revolutions in ICT And Beyond
    Research areas: Nuclear physics, cognitive radio, SDR, DECT
    
    •Alberto Morpurgo
    Organisation: UNIVERSITE DE GENEVE, RUE DU GENERAL DUFOUR 24, 1211 GENEVE, CH
    Project title: Graphene-Based Revolutions in ICT And Beyond
    Research areas: Quantum electronics, topological materials, condensed matter physics
    
    •Evgeni Ivanov
    Organisation: RESEARCH AND DEVELOPMENT OF NANOMATERIALS AND NANOTECHNOLOGY NANO TECHLAB LTD, ACAD G BONCHEV STR BLOCK 4, 1113 Sofia, BG
    Project title: Graphene-Based Revolutions in ICT And Beyond
    Research areas: Polymer nanocomposites, rheology-structure-properties relationship, mechanical properties
    """,
    """
    •Neil Hickinson
    Organisation: IFM EDUCATION AND CONSULTANCY SERVICES, TRINITY LANE THE OLD SCHOOLS, CB2 1TS Cambridge, UK
    Project title: Development of a Strategic Research and Innovation Roadmap for Future Architectures and Services for Manufacturing in Europe and Derivation of Business Opportunities
    Research areas: Sustainable manufacturing, AI-driven process optimization, circular production

    •Eduardo Herrmann
    Organisation: STEINBEIS INNOVATION GGMBH, ADORNOSTRASSE 8, 70599 Stuttgart, DE
    Project title: Development of a Strategic Research and Innovation Roadmap for Future Architectures and Services for Manufacturing in Europe and Derivation of Business Opportunities
    Research areas: Innovation management, sustainable manufacturing, AI technologies

    •Walter Krause
    Organisation: FRAUNHOFER GESELLSCHAFT ZUR FORDERUNG DER ANGEWANDTEN FORSCHUNG EV, HANSASTRASSE 27C, 80686 MUNCHEN, DE
    Project title: Development of a Strategic Research and Innovation Roadmap for Future Architectures and Services for Manufacturing in Europe and Derivation of Business Opportunities
    Research areas: AI in manufacturing, process optimization, sustainable technologies

    •Augusto Vilarinho
    Organisation: CRITICAL MANUFACTURING SA, RUA ENG FREDERICO ULRICH 2650, 4470-605 MOREIRA DA MAIA PORTO, PT
    Project title: Development of a Strategic Research and Innovation Roadmap for Future Architectures and Services for Manufacturing in Europe and Derivation of Business Opportunities
    Research areas: Manufacturing Execution Systems (MES), AI-driven automation, industrial resilience

    •Eva Coscia
    Organisation: TXT E-SOLUTIONS SPA, VIA MILANO 150, 20093 Cologno Monzese, IT
    Project title: Development of a Strategic Research and Innovation Roadmap for Future Architectures and Services for Manufacturing in Europe and Derivation of Business Opportunities
    Research areas: IT and project management, AI technologies, sustainable manufacturing

    •Anirban Majumdar
    Organisation: SAP SE, DIETMAR HOPP ALLEE 16, 69190 Walldorf, DE
    Project title: Development of a Strategic Research and Innovation Roadmap for Future Architectures and Services for Manufacturing in Europe and Derivation of Business Opportunities
    Research areas: Platform adoption, AI-driven process optimization, sustainable manufacturing

    •Haydn Thompson
    Organisation: THHINK WIRELESS TECHNOLOGIES LIMITED, 1 HAUGH LANE, S11 9SA SHEFFIELD, UK
    Project title: Development of a Strategic Research and Innovation Roadmap for Future Architectures and Services for Manufacturing in Europe and Derivation of Business Opportunities
    Research areas: Wireless technologies, AI in manufacturing, sustainable production

    •Daniel Cuiñas
    Organisation: CENTRE CIM FUNDACIO PRIVADA, Carrer Llorens i Artigas 12, 08028 Barcelona, ES
    Project title: Sustainable Manufacturing Adaptive Services with Cloud Architectures for Enterprises
    Research areas: 3D printing, advanced materials, AI-driven manufacturing

    •Donald Lack
    Organisation: INENCO GROUP LIMITED, ST ANDREWS ROAD NORTH PETROS HOUSE, FY8 2NF LYTHAM ST ANNES, UK
    Project title: Sustainable Manufacturing Adaptive Services with Cloud Architectures for Enterprises
    Research areas: Energy consultancy, sustainable manufacturing, AI technologies

    •Magnus Holm
    Organisation: HOGSKOLAN I SKOVDE, HOGSKOLEVAGEN 1, 54 128 SKOVDE, SE
    Project title: Sustainable Manufacturing Adaptive Services with Cloud Architectures for Enterprises
    Research areas: Cloud manufacturing, AI-driven process optimization, sustainable production
    """,
    """
    •Jacques Sauzede
    Organisation: THALES AVS FRANCE SAS, 75-77 Avenue Marcel Dassault, 33700 Merignac, FR
    Project title: Coordination action on Risks, Evolution of threatS and context assessment by an Enlarged Network for r&D rOadmap
    Research areas: Security research, threat assessment, risk management
    
    •Jean Francois Legendre
    Organisation: ASSOCIATION FRANCAISE DE NORMALISATION, Avenue Francis de Pressence 11, 93571 Saint Denis La Plaine, FR
    Project title: Coordination action on Risks, Evolution of threatS and context assessment by an Enlarged Network for r&D rOadmap
    Research areas: Standardization, security technologies, research coordination
    
    •Michael Parik
    Organisation: ÖSTERREICHISCHES FORSCHUNGS- UND PRÜFZENTRUM ARSENAL GES.M.B.H., Giefinggasse 2, 1210 Vienna, AT
    Project title: Coordination action on Risks, Evolution of threatS and context assessment by an Enlarged Network for r&D rOadmap
    Research areas: Security research, technology assessment, innovation management
    
    •Will Mcmeechan
    Organisation: EUROPEAN BIOMETRIC FORUM LIMITED, Thomas Street, N/A Dublin 8, IE
    Project title: Coordination action on Risks, Evolution of threatS and context assessment by an Enlarged Network for r&D rOadmap
    Research areas: Biometric security, technology innovation, stakeholder engagement
    
    •René F.W.M. Willems
    Organisation: NEDERLANDSE ORGANISATIE VOOR TOEGEPAST NATUURWETENSCHAPPELIJK ONDERZOEK TNO, Anna van Buerenplein 1, 2595 DA Den Haag, NL
    Project title: Coordination action on Risks, Evolution of threatS and context assessment by an Enlarged Network for r&D rOadmap
    Research areas: Applied scientific research, security technologies, innovation deployment
    
    •Jan Foghelin
    Organisation: TOTALFORSVARETS FORSKNINGSINSTITUT, Gullfossgatan 6, 164 90 Stockholm, SE
    Project title: Coordination action on Risks, Evolution of threatS and context assessment by an Enlarged Network for r&D rOadmap
    Research areas: Defense research, security innovation, threat analysis
    
    •Jean-Pierre Darnis
    Organisation: ISTITUTO AFFARI INTERNAZIONALI, Via dei Montecatini 17, 00186 Roma, IT
    Project title: Coordination action on Risks, Evolution of threatS and context assessment by an Enlarged Network for r&D rOadmap
    Research areas: International relations, security policy, defense research
    
    •Brigitte Serreault
    Organisation: AIRBUS DEFENCE AND SPACE SAS, 31 Rue des Cosmonautes ZI du Palays, 31402 Toulouse Cedex, FR
    Project title: Coordination action on Risks, Evolution of threatS and context assessment by an Enlarged Network for r&D rOadmap
    Research areas: Aerospace security, defense technologies, innovation management
    
    •Hans-Guenther Schneider
    Organisation: JRC -JOINT RESEARCH CENTRE- EUROPEAN COMMISSION, Rue de la Loi 200, 1049 Brussels, BE
    Project title: Coordination action on Risks, Evolution of threatS and context assessment by an Enlarged Network for r&D rOadmap
    Research areas: Security research, policy support, technology assessment
    
    •Lucien Mille
    Organisation: FONDATION POUR LA RECHERCHE STRATEGIQUE, 55 rue Raspail, 92300 Levallois-Perret, FR
    Project title: Coordination action on Risks, Evolution of threatS and context assessment by an Enlarged Network for r&D rOadmap
    Research areas: Strategic research, security policy, defense innovation
    """,
    """
    •Kadri Raav
    Organisation: TARTU ULIKOOL, ULIKOOLI 18, 51005 TARTU, EE
    Project title: EuroREACH A Handbook to Access Health Care Data for Cross-country Comparisons of Efficiency and Quality
    Research areas: Health data interoperability, project management, genomics
    
    •Shaun Power
    Organisation: IMPERIAL COLLEGE OF SCIENCE TECHNOLOGY AND MEDICINE, SOUTH KENSINGTON CAMPUS EXHIBITION ROAD, SW7 2AZ LONDON, UK
    Project title: EuroREACH A Handbook to Access Health Care Data for Cross-country Comparisons of Efficiency and Quality
    Research areas: Research services management, health data integration
    
    •Hadas Lewy
    Organisation: MACCABI SHEIRUTEI BRIUT FOUNDATION, HAMERED STREET 27, 68125 Tel Aviv, IL
    Project title: EuroREACH A Handbook to Access Health Care Data for Cross-country Comparisons of Efficiency and Quality
    Research areas: Digital health ventures, applied research for elderly technologies
    
    •Dominique Goldfarb
    Organisation: INSTITUT DE RECHERCHE ET DOCUMENTATION EN ECONOMIE DE LA SANTE ASSOCIOATION, RUE VAUVENARGUES 10, 75018 PARIS, FR
    Project title: EuroREACH A Handbook to Access Health Care Data for Cross-country Comparisons of Efficiency and Quality
    Research areas: Health economics, health data documentation
    
    •Simone Ludwig
    Organisation: TECHNISCHE UNIVERSITAT BERLIN, STRASSE DES 17 JUNI 135, 10623 Berlin, DE
    Project title: EuroREACH A Handbook to Access Health Care Data for Cross-country Comparisons of Efficiency and Quality
    Research areas: Privacy awareness, security branding
    
    •Jaakko Penttinen
    Organisation: TERVEYDEN JA HYVINVOINNIN LAITOS, MANNERHEIMINTIE 166, 00271 Helsinki, FI
    Project title: EuroREACH A Handbook to Access Health Care Data for Cross-country Comparisons of Efficiency and Quality
    Research areas: IT architecture, health data management
    
    •Champa Heidbrink
    Organisation: LONDON SCHOOL OF ECONOMICS AND POLITICAL SCIENCE, Houghton Street 1, WC2A 2AE London, UK
    Project title: EuroREACH A Handbook to Access Health Care Data for Cross-country Comparisons of Efficiency and Quality
    Research areas: Psychological and behavioural science, strategic planning
    
    •Pierre Hausman
    Organisation: LISER - LUXEMBOURG INSTITUTE OF SOCIO-ECONOMIC RESEARCH, 11 PORTE DES SCIENCES CAMPUS BLEVAL, 4366 ESCH SUR ALZETTE, LU
    Project title: EuroREACH A Handbook to Access Health Care Data for Cross-country Comparisons of Efficiency and Quality
    Research areas: Socio-economic research, living conditions
    
    •Flip Maas
    Organisation: EUROPAISCHES ZENTRUM FUR WOHLFAHRTSPOLITIK UND SOZIALFORSCHUNG, BERGGASSE 17, 1090 WIEN, AT
    Project title: EuroREACH A Handbook to Access Health Care Data for Cross-country Comparisons of Efficiency and Quality
    Research areas: Welfare policy, social research
    
    •Dipak Kalra
    Organisation: EUROPEAN INSTITUTE FOR HEALTH RECORDS, RUE DU MARECHAL DE LATTRE DE TASSIGNY 8, 59000 LILLE, FR
    Project title: Semantic Interoperability for Health Network
    Research areas: Health informatics, electronic health records
    """,
    """
    •Nuno Cunha
    Organisation: YUCCA, LDA, PRACETA JOSE SARAMAGO 3 C V ESQ A, 2630 291 ARRUDA DOS VINHOS, PT
    Project title: Future INternEt Smart Utility ServiCEs
    Research areas: Strategic Marketing, Communication Marketing, Management
    
    •Elmer Stöwer
    Organisation: SEnerCon GmbH, Hochkirchstrasse 11, 10829 Berlin, DE
    Project title: Future INternEt Smart Utility ServiCEs
    Research areas: Energy Efficiency Monitoring, EU Project Management
    
    •Irene Inchingolo
    Organisation: ISTITUTO SUPERIORE MARIO BOELLA SULLE TECNOLOGIE DELL'INFORMAZIONE E DELLE TELECOMUNICAZIONI ASSOCIAZIONE, VIA PIER CARLO BOGGIO 61, 10138 TORINO, IT
    Project title: Future INternEt Smart Utility ServiCEs
    Research areas: Project Management, Information Technologies
    
    •Kaj Leonhart Petersen
    Organisation: ENERGY CONSULTING NETWORK AS, SOEREN FRICHSVEJ 42 D ST, 8230 AABYHOJ, DK
    Project title: Future INternEt Smart Utility ServiCEs
    Research areas: Energy Planning, Management Consulting
    
    •Steen Kramer Jensen
    Organisation: INSERO ENERGY AS, KOBENHAVN 4A, 8700 HORSENS, DK
    Project title: Future INternEt Smart Utility ServiCEs
    Research areas: IoT Solutions, Renewable Energy
    
    •Laura Pipan Petan
    Organisation: XLAB RAZVOJ PROGRAMSKE OPREME IN SVETOVANJE DOO, POT ZA BRDOM 100, 1000 Ljubljana, SI
    Project title: Future INternEt Smart Utility ServiCEs
    Research areas: Financial Management, Legal Department
    
    •Clementine Gleizal
    Organisation: INSTITUT POLYTECHNIQUE DE GRENOBLE, AVENUE FELIX VIALLET 46, 38031 GRENOBLE CEDEX 1, FR
    Project title: Future INternEt Smart Utility ServiCEs
    Research areas: European Projects, Policies
    
    •Ludwig Karg
    Organisation: B.A.U.M. CONSULT GMBH, GOTZINGER STR. 48/50, 81371 MUNCHEN, DE
    Project title: Future INternEt Smart Utility ServiCEs
    Research areas: Sustainable Development, Technology Consulting
    
    •Petr Stluka
    Organisation: HONEYWELL, SPOL. S.R.O, V PARKU 18, 14800 PRAHA, CZ
    Project title: Future INternEt Smart Utility ServiCEs
    Research areas: Data Analytics, Building Diagnostics
    
    •Andy Drysdale
    Organisation: INSERO BUSINESS SERVICES AS, CHR M OSTERGAARDS VEJ 4 A, 8700 HORSENS, DK
    Project title: Future INternEt Smart Utility ServiCEs
    Research areas: Innovation Management, Electrical Engineering
    """,
    """
    Daniel Van Lerberghe
    Organisation: FONDATION EURACTIV POLITECH, BOULEVARD CHARLEMAGNE 1, BATIMENT IPC, 1041 BRUXELLES, BE
    Project title: EU Community
    Research areas: Political Technologies, Social Media, Innovation Labs
    
    •Christoph Schulte
    Organisation: FRAUNHOFER GESELLSCHAFT ZUR FORDERUNG DER ANGEWANDTEN FORSCHUNG EV, HANSASTRASSE 27C, 80686 MUNCHEN, DE
    Project title: EU Community
    Research areas: Urban Data Processing, Environmental Research, Digital Content
    
    •Stathis Dimakos
    Organisation: ATHENS TECHNOLOGY CENTER ANONYMI VIOMICHANIKI EMPORIKI KAI TECHNIKI ETAIREIA EFARMOGON YPSILIS TECHNOLOGIAS, RIZAREIOU 10, 15233 ATHINA, EL
    Project title: EU Community
    Research areas: Information Technologies, Global Systems, Social Media Analysis
    
    •David Mekkaoui
    Organisation: EURACTIV.COM LIMITED, ALDERSGATE STREET 150, EC1A 4AB LONDON, UK
    Project title: EU Community
    Research areas: Media Innovation, EU Affairs, Digital Skills
    
    •Antonis Ramfos
    Organisation: NETCOMPANY-INTRASOFT SA, RUE NICOLAS BOVE 2B, 1253 Luxembourg, LU
    Project title: EU Community
    Research areas: Innovation and Business Development, Risk Assessment, Contingency Planning
    
    •Noemí Castro
    Organisation: FUNDACIO PER A LA UNIVERSITAT OBERTA DE CATALUNYA, AVENIDA TIBIDABO 39, 08035 Barcelona, ES
    Project title: EU Community
    Research areas: Digital Marketing, Surveillance Societies, Cognitive Decline Prevention
    
    •Yannis Charalabidis
    Organisation: PANEPISTIMIO AIGAIOU, LOFOS PANEPISTIMIOU, 81100 MYTILINI, EL
    Project title: EU Community
    Research areas: Digital Governance, Information Systems, Government Technologies
    
    •Radovan Geist
    Organisation: I-EUROPA SRO, MAROTHYHO 6, 811 06 BRATISLAVA MESTKA CAST STARE MESTO, SK
    Project title: EU Community
    Research areas: European Solidarity, Journalism, Media Analysis
    
    •Alkis Papacharisis
    Organisation: NETCOMPANY - INTRASOFT, PLACE DU CHAMP DE MARS 5/10, 1050 BRUXELLES, BE
    Project title: EU Community
    Research areas: Project Management, Contract Management, Digital Solutions
    
    •Guido Van Steendam
    Organisation: INTERNATIONAL FORUM FOR BIOPHILOSOPHY, CRAENENDONCK 15, 3000 LEUVEN, BE
    Project title: Virtual Centre of Excellence for Ethically-guided and Privacy-respecting Video Analytics
    Research areas: Biophilosophy, Ethics, Privacy
    
    •Reuben Almeida
    Organisation: QUEEN MARY UNIVERSITY OF LONDON, 327 MILE END ROAD, E1 4NS LONDON, UK
    Project title: Virtual Centre of Excellence for Ethically-guided and Privacy-respecting Video Analytics
    Research areas: European Projects Management, Research Coordination, Robotics
    
    •Sylvie Raynaud
    Organisation: THALES SIX GTS FRANCE SAS, AVENUE DES LOUVRESSES 4, 92230 Gennevilliers, FR
    Project title: Virtual Centre of Excellence for Ethically-guided and Privacy-respecting Video Analytics
    Research areas: R&D, Marketing & Sales, Security Solutions
    
    •Diego Fernández Vázquez
    Organisation: INGENIERIA DE SISTEMAS PARA LA DEFENSA DE ESPANA SA-SME MP, CALLE BEATRIZ DE BOBADILLA 3, 28040 MADRID, ES
    Project title: Virtual Centre of Excellence for Ethically-guided and Privacy-respecting Video Analytics
    Research areas: Security Systems, Defense Engineering, Traffic Management
    
    •Simone Ludwig
    Organisation: TECHNISCHE UNIVERSITAT BERLIN, STRASSE DES 17 JUNI 135, 10623 Berlin, DE
    Project title: Virtual Centre of Excellence for Ethically-guided and Privacy-respecting Video Analytics
    Research areas: Privacy Awareness, Security Branding, Data Science
    
    •Claire Cristofaro
    Organisation: EURECOM GIE, ROUTE DES CHAPPES 450 CAMPUS SOPHIA ANTIPOLIS, 06410 Biot, FR
    Project title: Virtual Centre of Excellence for Ethically-guided and Privacy-respecting Video Analytics
    Research areas: Project Control, Business Administration, Research Finance
    
    •Atta Badii
    Organisation: THE UNIVERSITY OF READING, WHITEKNIGHTS CAMPUS WHITEKNIGHTS HOUSE, RG6 6AH READING, UK
    Project title: Virtual Centre of Excellence for Ethically-guided and Privacy-respecting Video Analytics
    Research areas: Secure Pervasive Technologies, Cybersecurity, Intelligent Systems
    
    •Touradj Ebrahimi
    Organisation: ECOLE POLYTECHNIQUE FEDERALE DE LAUSANNE, BATIMENT CE 3316 STATION 1, 1015 Lausanne, CH
    Project title: Virtual Centre of Excellence for Ethically-guided and Privacy-respecting Video Analytics
    Research areas: Multimedia Signal Processing, JPEG Standardization, Electrical Engineering
    
    •William Marshall
    Organisation: UNIVERSITY OF THE WEST OF ENGLAND, BRISTOL, Frenchay Campus, Coldharbour Lane, BS16 1QY Bristol, UK
    Project title: Media Accountability and Transparency in Europe
    Research areas: Media Accountability, Transparency, Higher Education
    
    •Daniela Kraus
    Organisation: MEDIENHAUS WIEN FORSCHUNG UND WEITERBILDUNG GmbH, Alser Straße 22, 1090 Vienna, AT
    Project title: Media Accountability and Transparency in Europe
    Research areas: Media Research, Journalism, Media Education
    
    •Michela Carli
    Organisation: UNIVERSITA DELLA SVIZZERA ITALIANA, VIA GIUSEPPE BUFFI 13, 6900 Lugano, CH
    Project title: Media Accountability and Transparency in Europe
    Research areas: Media Studies, Communication, Non-Profit Leadership
    
    •Julia Lönnendonker
    Organisation: ERICH-BROST INSTITUT FUR JOURNALISMUS IN EUROPA GEMEINNUTZIGE GESELLSCHAFT MIT BESCHRANKTER HAFTUNG EBI GMBH, OTTO HAHN STRASSE 2, 44221 DORTMUND, DE
    Project title: Media Accountability and Transparency in Europe
    Research areas: Journalism, Media Accountability, Communication Studies
    
    •Josiane Jouet
    Organisation: UNIVERSITE PARIS II PANTHEON ASSAS, Place du Pantheon 12, 75231 PARIS, FR
    Project title: Media Accountability and Transparency in Europe
    Research areas: Sociology, Media Studies, Communication
    
    •Mihai Coman
    Organisation: UNIVERSITATEA DIN BUCURESTI, SOSEAUA PANDURI 90, 050663 Bucuresti, RO
    Project title: Media Accountability and Transparency in Europe
    Research areas: Journalism, Communication, Media Systems
    
    •Huub Evers
    Organisation: STICHTING FONTYS, RACHELSMOLEN 1, 5612 MA EINDHOVEN, NL
    Project title: Media Accountability and Transparency in Europe
    Research areas: Media Ethics, Intercultural Journalism, Media Accountability
    
    •Sophie Regnier
    Organisation: INSTITUT D'ETUDES POLITIQUES DE TOULOUSE, RUE DES PUITS CREUSES 2 ter, 31000 TOULOUSE, FR
    Project title: Media Accountability and Transparency in Europe
    Research areas: Political Studies, Media Research, Documentation
    
    •Mike Jempson
    Organisation: THE MEDIAWISE TRUST, OLDBURY COURT ROAD, BS16 2JP Bristol, UK
    Project title: Media Accountability and Transparency in Europe
    Research areas: Journalism Ethics, Media Accountability, Public Relations
    
    •Hannele Auffermann
    Organisation: TAMPEREEN YLIOPISTO, Kalevantie 4, 33014 TAMPERE, FI
    Project title: Media Accountability and Transparency in Europe
    Research areas: Operations Management, Administrative Services, Economic Growth
    
    •Boguslawa Dobek-Ostrowska
    Organisation: UNIWERSYTET WROCLAWSKI, PL UNIWERSYTECKI 1, 50137 WROCLAW, PL
    Project title: Media Accountability and Transparency in Europe
    Research areas: Social Communication, Journalism, Media Systems
    
    •Halliki Harro-Loit
    Organisation: TARTU ULIKOOL, ULIKOOLI 18, 51005 TARTU, EE
    Project title: Media Accountability and Transparency in Europe
    Research areas: Journalism, Communication, Media Studies
    
    •Giamprima Stabilini
    Organisation: UNIVERSITA DEGLI STUDI DI MILANO, Via Festa Del Perdono 7, 20122 Milano, IT
    Project title: Media Accountability and Transparency in Europe
    Research areas: Environmental Sciences, Administrative Support, Research Services
    """,
    """
    •Nadia Magnenat-Thalmann
    Organisation: Université de Genève, Rue du Général Dufour 24, 1211 Genève, CH
    Project title: Bringing the Media Internet to Life
    Research areas: Virtual Humans, Augmented Reality, 3D Fashion, Interactive Virtual Humans
    
    •Hyoung Joong Kim
    Organisation: Korea University Research and Business Foundation, Anam dong, Seongbuk-gu 5-1, 136701 Seoul, KR
    Project title: Bringing the Media Internet to Life
    Research areas: Multimedia Security, Digital Forensics, Digital Watermarking, Parallel Computing
    
    •Florence PHILIPPART
    Organisation: Institut Mines-Télécom, 19 Place Marguerite Perey, 91120 Palaiseau, FR
    Project title: Bringing the Media Internet to Life
    Research areas: Communication and Media Studies, Signal Processing
    
    •Noel O'Connor
    Organisation: Dublin City University, Glasnevin, 9 Dublin, IE
    Project title: Bringing the Media Internet to Life
    Research areas: Multimedia Content Analysis, Computer Vision, Machine Learning, Information Fusion
    
    •Petros Daras
    Organisation: Ethniko Kentro Erevnas Kai Technologikis Anaptyxis, Charilaou Thermi Road 6 KM, 57001 Thermi Thessaloniki, EL
    Project title: Bringing the Media Internet to Life
    Research areas: Computer Vision, Machine Learning, Media Processing, 3D Reconstruction
    
    •Ebroul Izquierdo
    Organisation: Queen Mary University of London, 327 Mile End Road, E1 4NS London, UK
    Project title: Bringing the Media Internet to Life
    Research areas: Multimedia Signal Processing, Computer Vision, Image Processing
    
    •Andrea Zeumann
    Organisation: Fraunhofer Gesellschaft zur Förderung der Angewandten Forschung EV, Hansastrasse 27C, 80686 München, DE
    Project title: Bringing the Media Internet to Life
    Research areas: Visual Analytics, Micro-forming, 3D Metal Parts Manufacturing
    
    •Sandrine LANNUZEL
    Organisation: Association Régionale du Conservatoire National des Arts et Métiers dans les Pays de la Loire (A.R.C.N.A.M.), BD Guy Mollet 25, 44311 Nantes, FR
    Project title: Manufacturing Service Ecosystem
    Research areas: Financial Management, Human Resources, Information Systems
    
    •Michel Bijvoet
    Organisation: Douélou NV, Kempische Steenweg 303, Bus 56, 3500 Hasselt, BE
    Project title: Manufacturing Service Ecosystem
    Research areas: Biomolecular Research, Public Affairs
    
    •Kai Mertins
    Organisation: Laboratoire Virtuel Européen dans le Domaine de l'Interoperabilité des Entreprises, Rue Montoyer 21, 1000 Bruxelles, BE
    Project title: Manufacturing Service Ecosystem
    Research areas: Supply Chain Management, Simulation, Management Accounting
    
    •Sergio Gusmeroli
    Organisation: TXT E-Solutions SPA, Via Milano 150, 20093 Cologno Monzese, IT
    Project title: Manufacturing Service Ecosystem
    Research areas: Industry 4.0, AI for Manufacturing, Digital Innovation Hubs
    
    •Alice Carpentier
    Organisation: Universität Innsbruck, Innrain 52, 6020 Innsbruck, AT
    Project title: Manufacturing Service Ecosystem
    Research areas: Wildlife Conservation, Biological and Ecological Research
    
    •Laura Catellani
    Organisation: Politecnico di Milano, Piazza Leonardo da Vinci 32, 20133 Milano, IT
    Project title: Manufacturing Service Ecosystem
    Research areas: Industrial Engineering, Management, Economics
    
    •Arne Duwaer
    Organisation: TP Vision Europe BV, Prins Bernhardplein 200, 1097 JB Amsterdam, NL
    Project title: Manufacturing Service Ecosystem
    Research areas: Innovation Management, Computer Science
    
    •Patrick Keur
    Organisation: Philips Consumer Lifestyle BV, High Tech Campus 52, 5656 AG Eindhoven, NL
    Project title: Manufacturing Service Ecosystem
    Research areas: Financial Project Management, Consumer Competence Research
    
    •Adolfo Steiger-Garçaõ
    Organisation: UNINOVA-Instituto de Desenvolvimento de Novas Tecnologias-Associação, Campus da Caparica Quinta da Torre, 2829-516 Caparica, PT
    Project title: Manufacturing Service Ecosystem
    Research areas: Enterprise Interoperability, Electromagnetic Modeling
    
    •Barbara Cimarra
    Organisation: Whirlpool EMEA SRL, Via Varesina 204, 20156 Milano, IT
    Project title: Manufacturing Service Ecosystem
    Research areas: Senior Buyer, Marketing, Logistics
    
    •Arrate Olaiz
    Organisation: IBARMIA Innovatek, S.L, Pol. Ind. Etxesaga s/n, 20720 Azkoitia, ES
    Project title: Manufacturing Service Ecosystem
    Research areas: Innovation Management, High-tech Machining Solutions
    
    •Sylvie Gavirey
    Organisation: BIBA - Bremer Institut für Produktion und Logistik GmbH, Hochschulring 20, 28359 Bremen, DE
    Project title: Manufacturing Service Ecosystem
    Research areas: RFID Technology, Logistics, Enterprise Collaboration
    
    •Stelios Pantelopoulos
    Organisation: SingularLogic Anonymi Etairia Pliroforiakon Systimaton Kai Efarmogon Pliroforikis, Achaias 3 & Troizinias, 14564 Nea Kifisia, EL
    Project title: Manufacturing Service Ecosystem
    Research areas: Software Engineering, Robotics, Brain Training
    
    •Maria Luisa Porro
    Organisation: Engineering - Ingegneria Informatica SPA, Piazzale dell'Agricoltura 24, 00144 Roma, IT
    Project title: Manufacturing Service Ecosystem
    Research areas: Administrative and Accounting, Business Management
    
    •Enrico Morten
    Organisation: Softeco Sismat SRL, Via De Marini 1, 16149 Genova, IT
    Project title: Manufacturing Service Ecosystem
    Research areas: Computer Graphics, Medieval Reconstruction, Innovation Management
    
    •Andreas Friesen
    Organisation: SAP SE, Dietmar Hopp Allee 16, 69190 Walldorf, DE
    Project title: Manufacturing Service Ecosystem
    Research areas: Service Science, Cloud Computing, Software Engineering
    
    •Zein SROUR
    Organisation: Hardis, Rue de la Tuilerie 34, 38170 Seyssinet-Pariset, FR
    Project title: Manufacturing Service Ecosystem
    Research areas: Zein-based Coatings, Antiviral Performance, Nanostructured Coatings
    
    •Peter Steiger
    Organisation: Deutsche Institute für Textil- und Faserforschung Denkendorf, Korsthalstrasse 26, 73770 Denkendorf, DE
    Project title: Manufacturing Service Ecosystem
    Research areas: Intensive Care Medicine, Traumatic Brain Injury, Mechanical Ventilation
    
    •Daniel Cuiñas
    Organisation: Centre CIM Fundacio Privada, Carrer Llorens i Artigas 12, 08028 Barcelona, ES
    Project title: Sustainable Manufacturing Adaptive Services with Cloud Architectures for Enterprises
    Research areas: Nonlinear Dynamics, Complex Systems, Chemical Physics
    
    •Donald Lack
    Organisation: Inenco Group Limited, St Andrews Road North Petros House, FY8 2NF Lytham St Annes, UK
    Project title: Sustainable Manufacturing Adaptive Services with Cloud Architectures for Enterprises
    Research areas: RNAi Knockdown, Lipoprotein Changes, Focal Adhesion Protein
    
    •Magnus Holm
    Organisation: Hogskolan I Skovde, Hogskolevagen 1, 54 128 Skovde, SE
    Project title: Sustainable Manufacturing Adaptive Services with Cloud Architectures for Enterprises
    Research areas: Shop-floor Decision Support Systems, Digital Strategy, Industry 4.0
    
    •Tobias Bohlin
    Organisation: Swegon AB, Frejgatan 14, 53523 Kvänum, SE
    Project title: Sustainable Manufacturing Adaptive Services with Cloud Architectures for Enterprises
    Research areas: Business Model Innovation, Sustainability, Value Creation
    
    •Rod Hilditch
    Organisation: Freight Operators Commercial Access Link (FOCAL) Limited, Swift Road Coventry University, CV1 2TW Coventry, UK
    Project title: Sustainable Manufacturing Adaptive Services with Cloud Architectures for Enterprises
    Research areas: Manufacturing Information Management, Sustainable Applications, Kaizen
    
    •Joachim Friedhoff
    Organisation: Formtec Ingenieurgesellschaft für den Werkzeug- und Formenbau MBH, Hiesfelder Strasse 26, 46244 Bottrop, DE
    Project title: Sustainable Manufacturing Adaptive Services with Cloud Architectures for Enterprises
    Research areas: Mechanical Engineering, Virtual Reality Applications, CNC Milling
    """,
    """
    •Zinovia Papatheodorou
    Organisation: IDRYMA TECHNOLOGIAS KAI EREVNAS, N Plastira Str 100, 70013 Irakleio, Greece
    Project title: REliable, Resilient and secUre IoT for sMart city applications
    Research areas: Embedded sensors, wireless communication, IoT, smart city applications
    
    •Theodoros Mouroutis
    Organisation: CYTA HELLAS TILEPIKOINONIAKI AE, 128 Alexandras Avenue, 11471 Athina, Greece
    Project title: REliable, Resilient and secUre IoT for sMart city applications
    Research areas: IoT, smart city applications, wireless communication
    
    •Ilinca-Gabriela Gogonea
    Organisation: SIEMENS SRL, Bdul Preciziei 24 Imobil H3 Etaj 3-5 Sector 6, 062204 Bucuresti, Romania
    Project title: REliable, Resilient and secUre IoT for sMart city applications
    Research areas: IoT, smart city applications, embedded systems
    
    •Adam Kapovits
    Organisation: EURESCOM-EUROPEAN INSTITUTE FOR RESEARCH AND STRATEGIC STUDIES IN TELECOMMUNICATIONS GMBH, Wieblinger Weg 19/4, 69123 Heidelberg, Germany
    Project title: REliable, Resilient and secUre IoT for sMart city applications
    Research areas: Telecommunications, IoT, smart city applications
    
    •Marc Fàbregas Bachs
    Organisation: ZOLERTIA SL, Marie Curie, 8-14, 08042 Barcelona, Spain
    Project title: REliable, Resilient and secUre IoT for sMart city applications
    Research areas: IoT, embedded systems, smart city applications
    
    •Annlouise Jungskar
    Organisation: Linköping University, Campus Valla, 581 83 Linköping, Sweden
    Project title: REliable, Resilient and secUre IoT for sMart city applications
    Research areas: IoT, smart city applications, wireless communication
    
    •Josep Maria Adam
    Organisation: AJUNTAMENT DE TARRAGONA, Placa de la Font 1, 43003 Tarragona, Spain    
    Project title: REliable, Resilient and secUre IoT for sMart city applications
    Research areas: IoT, smart city applications, embedded systems
    
    •Sabine Wiendl
    Organisation: UNIVERSITAT PASSAU, Innstrasse 41, 94032 Passau, Germany
    Project title: REliable, Resilient and secUre IoT for sMart city applications
    Research areas: IoT, smart city applications, wireless communication
    
    •Adamantia Mavromati
    Organisation: HERAKLION MUNICIPALITY, Ag Titou 1, 71202 Heraklion, Greece
    Project title: REliable, Resilient and secUre IoT for sMart city applications
    Research areas: IoT, smart city applications, embedded systems
    
    •CHARALAMPOS VANGELATOS
    Organisation: ELLINIKI AEROPORIKI VIOMICHANIA ANONYMI ETAIREIA, Mesogeion 2-4, 11527 Athina, Greece
    Project title: Virtualized dIstributed plaTfoRms of smart Objects
    Research areas: IoT, smart objects, embedded systems
    """,
    """
    •Richard Beavis
    Organisation: BP EXPLORATION OPERATING COMPANY LTD, Chertsey Road, TW16 7BP SUNBURY-ON-THAMES, Middlesex, UK
    Project title: CArbon-free Electricity by SEWGS: Advanced materials, Reactor and process design
    Research areas: Carbon capture, pre-combustion technologies, hydrogen production
    
    •Tanja Spaan-Hagenaar
    Organisation: STICHTING ENERGIEONDERZOEK CENTRUM NEDERLAND, WESTERDUINWEG 3, 1755 LE Petten, NL
    Project title: CArbon-free Electricity by SEWGS: Advanced materials, Reactor and process design
    Research areas: Energy research, renewable energy integration, carbon-free electricity
    
    •Vincent White
    Organisation: AIR PRODUCTS PLC, Hersham Place - Molesey Road, KT12 4RZ WALTON-ON-THAMES, UK
    Project title: CArbon-free Electricity by SEWGS: Advanced materials, Reactor and process design
    Research areas: Green hydrogen technology, industrial gases, ammonia cracking
    
    •Rune Bredesen
    Organisation: STIFTELSEN SINTEF, STRINDVEIEN 4, 7034 Trondheim, NO
    Project title: CArbon-free Electricity by SEWGS: Advanced materials, Reactor and process design
    Research areas: Sustainable energy technology, carbon dioxide capture, hydrogen production
    
    •Matilde Cambiaghi
    Organisation: POLITECNICO DI MILANO, PIAZZA LEONARDO DA VINCI 32, 20133 MILANO, IT
    Project title: CArbon-free Electricity by SEWGS: Advanced materials, Reactor and process design
    Research areas: Calorimetry, energy systems, advanced materials
    
    •Helena Montiel
    Organisation: UNIVERSITAT DE GIRONA, PLACA SANT DOMENEC 3, 17004 Girona, ES
    Project title: Biological production of butanol from syngas
    Research areas: Chemical engineering, biological production, renewable energy
    
    •Maurizio Gentili
    Organisation: Enel Ingegneria e Innovazione SpA, Viale Regina Margherita 125, 00198 Rome, IT
    Project title: Enabling advanced pre-combustion capture techniques and plants
    Research areas: CO₂ storage, pre-combustion capture, energy innovation
    
    •Tove Hønstad
    Organisation: STIFTELSEN SINTEF, STRINDVEIEN 4, 7034 Trondheim, NO
    Project title: Enabling advanced pre-combustion capture techniques and plants
    Research areas: Carbon capture and storage, energy systems, financial management in research
    
    •Petra Van Der Ende
    Organisation: NEDERLANDSE ORGANISATIE VOOR TOEGEPAST NATUURWETENSCHAPPELIJK ONDERZOEK TNO, ANNA VAN BUERENPLEIN 1, 2595 DA DEN HAAG, NL
    Project title: Enabling advanced pre-combustion capture techniques and plants
    Research areas: Applied scientific research, energy systems, innovation
    
    •Madhavan Poyyapakkam
    Organisation: GENERAL ELECTRIC (SWITZERLAND) GMBH, BROWN BOVERI STRASSE 7, 5401 BADEN, CH
    Project title: Enabling advanced pre-combustion capture techniques and plants
    Research areas: Hydrogen/natural gas blends, gas turbine technology, internal consulting
    
    •Gaele Valet
    Organisation: IFP Energies nouvelles, AVENUE DE BOIS PREAU 1 & 4, 92500 RUEIL MALMAISON, FR
    Project title: Enabling advanced pre-combustion capture techniques and plants
    Research areas: Legal affairs in energy research, carbon capture, energy systems
    
    •Catherine Sophie Mantillet
    Organisation: CORNING SAS, Avenue de Valvins 7 bis, 77920 Samois Sur Seine, FR
    Project title: Enabling advanced pre-combustion capture techniques and plants
    Research areas: Advanced materials, energy systems, legal affairs
    
    •Marco Mazzotti
    Organisation: EIDGENOESSISCHE TECHNISCHE HOCHSCHULE ZUERICH, Raemistrasse 101, 8092 Zuerich, CH
    Project title: Enabling advanced pre-combustion capture techniques and plants
    Research areas: Process engineering, carbon capture, chemical engineering
    
    •Alexey Volkov
    Organisation: A.V. TOPCHIEV INSTITUTE OF PETROCHEMICAL SYNTHESIS - RUSSIAN ACADEMY OF SCIENCES, LENINSKY PR 29, 119991 MOSKVA, RU
    Project title: Enabling advanced pre-combustion capture techniques and plants
    Research areas: Petrochemical synthesis, polymeric membranes, engine oil regeneration
    
    •Benoit Davidian
    Organisation: L AIR LIQUIDE SA, QUAI D ORSAY 75, 75007 PARIS 07, FR
    Project title: Enabling advanced pre-combustion capture techniques and plants
    Research areas: Cryogenic distillation, air separation, carbon capture
    
    •Gunhild Engdal
    Organisation: NORGES TEKNISK-NATURVITENSKAPELIGE UNIVERSITET NTNU, HOGSKOLERINGEN 1, 7491 Trondheim, NO
    Project title: Enabling advanced pre-combustion capture techniques and plants
    Research areas: Project management, financial management, carbon capture
    
    •Marie Bysveen
    Organisation: SINTEF ENERGI AS, Sem Saelandsveg 11, 7465 Trondheim, NO
    Project title: Enabling advanced pre-combustion capture techniques and plants
    Research areas: Energy research, carbon capture, project coordination
    
    •Annet Stones
    Organisation: SHELL DOWNSTREAM SERVICES INTERNATIONAL BV, LANGE KLEINWEG 40 5 VERDIEPING 40, 2288 GK RIJSWIJK ZH, NL
    Project title: Enabling advanced pre-combustion capture techniques and plants
    Research areas: Climate change response, energy innovation, carbon capture
    
    •Ernst J. Harting
    Organisation: TECHNISCHE UNIVERSITEIT DELFT, STEVINWEG 1, 2628 CN Delft, NL
    Project title: Enabling advanced pre-combustion capture techniques and plants
    Research areas: Project management, organizational development, carbon capture
    
    •Anne-Marie Patton
    Organisation: UNIVERSITY OF ULSTER, CROMORE ROAD, BT52 1SA COLERAINE, UK
    Project title: Enabling advanced pre-combustion capture techniques and plants
    Research areas: Medication safety, pregnancy research, carbon capture
    """,
    """
    •Kyu Hwan Lee
    Organisation: Korea Institute of Science and Technology, 39-1 Hawolgok-Dong, Seongbuk-Gu, 136-791 Seoul, KR
    Project title: Multiscale Materials Modelling on High Performance Computer Architectures
    Research areas: Electrochemistry, surface engineering, energy nanomaterials
    
    •Florian von Wrochem
    Organisation: SONY DEUTSCHLAND GMBH, KEMPERPLATZ 1, 10785 BERLIN, DE
    Project title: Multiscale Materials Modelling on High Performance Computer Architectures
    Research areas: Organic electronics, molecular electronics, materials science
    
    •Kimmo Niittuaho
    Organisation: CSC-TIETEEN TIETOTEKNIIKAN KESKUS OY, KEILARANTA 14, 02101 Espoo, FI
    Project title: Multiscale Materials Modelling on High Performance Computer Architectures
    Research areas: Research data management, financial administration
    
    •Natascha Wallburg
    Organisation: KARLSRUHER INSTITUT FUER TECHNOLOGIE, KAISERSTRASSE 12, 76131 Karlsruhe, DE
    Project title: Multiscale Materials Modelling on High Performance Computer Architectures
    Research areas: Engineering, industrial innovation, hydrogen systems
    
    •Roberto Lazzaroni
    Organisation: UNIVERSITE DE MONS, PLACE DU PARC 20, 7000 Mons, BE
    Project title: Multiscale Materials Modelling on High Performance Computer Architectures
    Research areas: Chemistry, chiral self-assembly, molecular dynamic simulations
    
    •Paola Alberigo
    Organisation: CINECA CONSORZIO INTERUNIVERSITARIO, VIA MAGNANELLI 6/3, 40033 CASALECCHIO DI RENO BO, IT
    Project title: Multiscale Materials Modelling on High Performance Computer Architectures
    Research areas: High performance computing, European Commission project management
    
    •Yumi Matsumoto
    Organisation: NOKIA OYJ, KARAPORTTI 3, 02610 Espoo, FI
    Project title: Multiscale Materials Modelling on High Performance Computer Architectures
    Research areas: Social media content creation, translation, marketing
    
    •Vlasis Mavrantzas
    Organisation: PANEPISTIMIO PATRON, UNIVERSITY CAMPUS RIO PATRAS, 265 04 RIO PATRAS, EL
    Project title: Multiscale Materials Modelling on High Performance Computer Architectures
    Research areas: Polymer rheology, molecular dynamics, multiscale modelling
    
    •Andreas Kreutzer
    Organisation: K & S GMBH PROJEKTMANAGEMENT, PURWEIDER WINKEL 52, 52070 AACHEN, DE
    Project title: Integrative Computational Materials Engineering Expert Group
    Research areas: Project management, digital transformation, supply chain management
    
    •Ralph Bernhardt
    Organisation: SIMUFACT ENGINEERING GMBH, TEMPOWERKRING 3, 21079 HAMBURG, DE
    Project title: Integrative Computational Materials Engineering Expert Group
    Research areas: Metal forming sciences, manufacturing process simulation
    
    •Giuseppe Visimberga
    Organisation: STICHTING MATERIALS INNOVATION INSTITUTE (M2I), VAN DER BURGHWEG 1, 2628 CS Delft, NL
    Project title: Integrative Computational Materials Engineering Expert Group
    Research areas: Materials research, mechanical behaviour, durable surfaces
    
    •Miguel ángel Rodiel
    Organisation: FUNDACION IMDEA MATERIALES, CALLE ERIC KANDEL 2 PARQUE CIENTIFICO Y TECNOLOGICO TECNOGETAFE, 28906 Getafe, ES
    Project title: Integrative Computational Materials Engineering Expert Group
    Research areas: R&D management, technology transfer, materials science
    
    •Anders Engstrom
    Organisation: THERMO-CALC SOFTWARE AB, RASUNDAVAGEN 18-20, 169 67 SOLNA, SE
    Project title: Integrative Computational Materials Engineering Expert Group
    Research areas: Computational thermodynamics, Ni-base superalloys, cemented carbides
    
    •Laurent Adam
    Organisation: MSC SOFTWARE BELGIUM, RUE EMILE FRANCQUI 9 AXIS PARK, 1435 MONT SAINT GUIBERT, BE
    Project title: Integrative Computational Materials Engineering Expert Group
    Research areas: Numerical modelling, fiber-reinforced composites, homogenization models
    
    •Ernst Schmachtenberg
    Organisation: RHEINISCH-WESTFAELISCHE TECHNISCHE HOCHSCHULE AACHEN, TEMPLERGRABEN 55, 52062 Aachen, DE
    Project title: Integrative Computational Materials Engineering Expert Group
    Research areas: Plastic engineering, European research area, collaboration agreements
    
    •Kurt Schroeder
    Organisation: ACCESS e.V., Intzestrasse 5, 52072 Aachen, DE
    Project title: Integrative Computational Materials Engineering Expert Group
    Research areas: Nanotechnology materials, printed electronics, power conversion
    
    •Sandra Pérez
    Organisation: CENTRE INTERNACIONAL DE METODES NUMERICS EN ENGINYERIA, C GRAN CAPITAN, EDIFICI C1, CAMPUS NORD UPC SN, 08034 Barcelona, ES
    Project title: Integrative Computational Materials Engineering Expert Group
    Research areas: Computational engineering, project management, numerical methods
    """,
    """
    •Diana Schabregs
    Organisation: Maastricht University, Minderbroedersberg 4, 6200 MD Maastricht, NL
    Project title: Equality without borders? The protection of individuals against EU equality law
    Research areas: Finance & Control, Law, Equality Law
    
    •Oliver Moravcik
    Organisation: Slovak University of Technology in Bratislava, Vazovova 5, 81243 Bratislava, SK
    Project title: Improving the gender diversity management in materials research institutions
    Research areas: Strategic Projects, Development, Gender Diversity Management
    
    •Natascha Wallburg
    Organisation: Karlsruher Institut fuer Technologie, Kaiserstrasse 12, 76131 Karlsruhe, DE
    Project title: Improving the gender diversity management in materials research institutions
    Research areas: Administrative Contact, Gender Diversity Management
    
    •Ingrid Jakobson
    Organisation: Chalmers Tekniska Hogskola AB, 412 96 GOTEBORG, SE
    Project title: Improving the gender diversity management in materials research institutions
    Research areas: Administration, Gender Diversity Management
    
    •Maren Jochimsen
    Organisation: Plateforme Europeenne des Femmes Scientifiques AISBL, Rue d'Arlon 38, 1000 Bruxelles, BE
    Project title: Improving the gender diversity management in materials research institutions
    Research areas: Ecological Economics, Gender Diversity Management
    
    •Alessandro De Filippo
    Organisation: Universita degli Studi di Torino, Via Giuseppe Verdi 8, 10124 TORINO, IT
    Project title: Improving the gender diversity management in materials research institutions
    Research areas: Financial Management, Gender Diversity Management
    
    •Christina Lekka
    Organisation: Panepistimio Ioanninon, Panepistemioupole Panepistimio Ioanninon, 45110 IOANNINA, EL
    Project title: Improving the gender diversity management in materials research institutions
    Research areas: Physics, Computational Materials Science, Gender Diversity Management
    
    •Kurt Von Figura
    Organisation: Georg-August-Universitat Gottingen Stiftung Offentlichen Rechts, Wilhelmsplatz 1, 37073 GOTTINGEN, DE
    Project title: Improving the gender diversity management in materials research institutions
    Research areas: Biochemistry, Gender Diversity Management
    
    •Regina Grunde
    Organisation: Institut Jozef Stefan, Jamova 39, 1000 Ljubljana, SI
    Project title: Improving the gender diversity management in materials research institutions
    Research areas: Finance & Accounting, Gender Diversity Management
    
    •Oliver Gutfleisch
    Organisation: Leibniz Institut fur Festkorper und Werkstofforschung Dresden EV, Helmholtzstrasse 20, 01069 Dresden, DE
    Project title: Improving the gender diversity management in materials research institutions
    Research areas: Material Sciences, Gender Diversity Management
    
    •Wolfgang Mayrhofer
    Organisation: Wirtschaftsuniversitat Wien, Welthandelsplatz 1, 1020 WIEN, AT
    Project title: Improving the gender diversity management in materials research institutions
    Research areas: Behavioral Management, Gender Diversity Management
    
    •Xavier Leal
    Organisation: Universitat Autonoma de Barcelona, Edif A Campus de la UAB Bellaterra, 08193 CERDANYOLA DEL VALLES, ES
    Project title: Improving the gender diversity management in materials research institutions
    Research areas: Telecommunications, Gender Diversity Management
    
    •Jean Xavier Boucherle
    Organisation: Centre National de la Recherche Scientifique CNRS, Rue Michel Ange 3, 75794 Paris, FR
    Project title: Improving the gender diversity management in materials research institutions
    Research areas: Natural Sciences, Gender Diversity Management
    
    •Eva-Maria Stange
    Organisation: Saechsisches Staatsministerium fur Wissenschaft, Kultur und Tourismus, Wigardstrasse 17, 01097 Dresden, DE
    Project title: Improving the gender diversity management in materials research institutions
    Research areas: Education, Gender Diversity Management
    
    •Branko Zebec
    Organisation: Institut Informacijskih Znanosti, Presernova Ulica 17, 2000 Maribor, SI
    Project title: The Ethical GovernAnce of emergIng technologieS – New Governance Perspectives for Integrating Ethics into Technical Development Projects and Applications
    Research areas: Information Science, Ethical Governance
    
    •Michael Butterworth
    Organisation: Middlesex University Higher Education Corporation, The Burroughs, Hendon, NW4 4BT LONDON, UK
    Project title: The Ethical GovernAnce of emergIng technologieS – New Governance Perspectives for Integrating Ethics into Technical Development Projects and Applications
    Research areas: EU Research Funding, Ethical Governance
    
    •Guido Castelli
    Organisation: Universita Cattolica del Sacro Cuore, Largo Gemelli 1, 20123 MILANO, IT
    Project title: The Ethical GovernAnce of emergIng technologieS – New Governance Perspectives for Integrating Ethics into Technical Development Projects and Applications
    Research areas: International Relations, Ethical Governance
    
    •Christine Culot
    Organisation: Universite de Namur ASBL, Rue de Bruxelles 61, 5000 Namur, BE
    Project title: The Ethical GovernAnce of emergIng technologieS – New Governance Perspectives for Integrating Ethics into Technical Development Projects and Applications
    Research areas: Research Administration, Ethical Governance
    """,
    """
    •Renata Schaeffer
    Organisation: THE CHANCELLOR MASTERS AND SCHOLARS OF THE UNIVERSITY OF CAMBRIDGE, TRINITY LANE THE OLD SCHOOLS, CB2 1TN CAMBRIDGE, UK
    Project title: A Coordination Action for Soft Robotics
    Research areas: International Development, Institutional Relationships, Strategic Partnerships, Soft Robotics
    
    •Paolo DARIO
    Organisation: SCUOLA SUPERIORE DI STUDI UNIVERSITARI E DI PERFEZIONAMENTO S ANNA, PIAZZA MARTIRI DELLA LIBERTA 33, 56127 Pisa, IT
    Project title: A Coordination Action for Soft Robotics
    Research areas: Biomedical Robotics, Bio-inspired Robotics, Soft Robotics, Neuromorphic Computing
    
    •Fumiya Iida
    Organisation: EIDGENOESSISCHE TECHNISCHE HOCHSCHULE ZUERICH, Raemistrasse 101, 8092 Zuerich, CH
    Project title: A Coordination Action for Soft Robotics
    Research areas: Bio-inspired Robotics, Soft Robotics, Embedded AI Systems, Neuromorphic Computing
    
    •Jane Kraushaar-Geisse
    Organisation: MAX-PLANCK-GESELLSCHAFT ZUR FORDERUNG DER WISSENSCHAFTEN EV, HOFGARTENSTRASSE 8, 80539 MUNCHEN, DE
    Project title: Towards Very Large Scale Human-Robot Synergy
    Research areas: Human-Robot Interaction, Large Scale Human-Robot Synergy, Administrative Coordination
    
    •Hongbin Ma
    Organisation: Beijing Institute of Technology, SOUTH ZHONGGUANCUN STREET HAIDIAN DISTRICT 5, 100081 BEIJING, CN
    Project title: Bringing Human Neuromotor Intelligence to Robots
    Research areas: Adaptive Control, Robotics, Image Processing, Machine Learning, Multi-agent Systems
    """,
    """
    •Simeon Yates
    Organisation: SHEFFIELD HALLAM UNIVERSITY, HOWARD STREET CITY CAMPUS, S1 1WB SHEFFIELD, UK
    Project title: Strategic Pan-European Ballistics Intelligence Platform for Combating Organised Crime and Terrorism
    Research areas: Digital Culture, Communication and Computing, Crime Prevention, Cybersecurity
    
    •Gary Herrington
    Organisation: WEST MIDLANDS POLICE AND CRIME COMMISSIONER, West Midlands Police Headquarters, Lloyd House, Colmore Circus, Queensway, B4 6NQ Birmingham, UK
    Project title: Strategic Pan-European Ballistics Intelligence Platform for Combating Organised Crime and Terrorism
    Research areas: Law Enforcement, Crime Prevention, Cybersecurity
    
    •Paola Fantini
    Organisation: MIP - CONSORZIO PER L'INNOVAZIONE NELLA GESTIONE DELLE IMPRESE E DELLA PUBBLICA AMMINISTRAZIONE, PIAZZA LEONARDO DA VINCI 32, 20133 MILANO, IT
    Project title: Strategic Pan-European Ballistics Intelligence Platform for Combating Organised Crime and Terrorism
    Research areas: Management and Innovation, Industrial Technologies, Crime Prevention
    
    •Francesco Giunta
    Organisation: MINISTERO DELL'INTERNO, Piazza del Viminale 1, 00184 Rome, IT
    Project title: Strategic Pan-European Ballistics Intelligence Platform for Combating Organised Crime and Terrorism
    Research areas: Law Enforcement, Crime Prevention, Cybersecurity
    
    •Simon Nott
    Organisation: North Yorkshire Police Authority, Newby Wiske, DL7 9HA Northallerton, UK
    Project title: Strategic Pan-European Ballistics Intelligence Platform for Combating Organised Crime and Terrorism
    Research areas: Law Enforcement, Crime Prevention, Cybersecurity
    
    •Deborah Leary
    Organisation: FORENSIC PATHWAYS LIMITED, NINIAN WAY UNIT 3 NINIAN PARK, B77 5ES TAMWORTH, UK
    Project title: Strategic Pan-European Ballistics Intelligence Platform for Combating Organised Crime and Terrorism
    Research areas: Forensic Science, Threat Intelligence, Crime Prevention
    
    •Dawn Yeo
    Organisation: SAS SOFTWARE LIMITED, HENLEY ROAD WITTINGTON HOUSE, SL7 2EB MARLOW, UK
    Project title: Strategic Pan-European Ballistics Intelligence Platform for Combating Organised Crime and Terrorism
    Research areas: Software Development, Crime Prevention, Cybersecurity
    ...
    •Fachtna Murphy
    Organisation: AN GARDA SIOCHANA, Garda Headquarters, Phoenix Park, D8 Dublin, IE
    Project title: Strategic Pan-European Ballistics Intelligence Platform for Combating Organised Crime and Terrorism
    Research areas: Law Enforcement, Crime Prevention, Cybersecurity
    
    •Marc Pirlot
    Organisation: ECOLE ROYALE MILITAIRE - KONINKLIJKE MILITAIRE SCHOOL, Avenue de la Renaissance 30, 1000 Bruxelles, BE
    Project title: Strategic Pan-European Ballistics Intelligence Platform for Combating Organised Crime and Terrorism
    Research areas: Military Science, Crime Prevention, Cybersecurity
    """,
    """
    •Edwin Morley-Fletcher
    Organisation: LYNKEUS, LIVENZA 6, 00198 Rome, IT
    Project title: A Strategy for In-Silico Clinical Trials
    Research areas: ICT for Health, Health Sciences, Computational Modeling
    
    •Martina Contin
    Organisation: VIRTUAL PHYSIOLOGICAL HUMAN INSTITUTE FOR INTEGRATIVE BIOMEDICAL RESEARCH VZW, CELESTIJNENLAAN 300C, 3001 Heverlee, BE
    Project title: A Strategy for In-Silico Clinical Trials
    Research areas: Integrative Biomedicine, Computational Modeling, Bioinformatics
    
    •Karen El-Arifi
    Organisation: THE UNIVERSITY OF SHEFFIELD, FIRTH COURT WESTERN BANK, S10 2TN SHEFFIELD, UK
    Project title: A Strategy for In-Silico Clinical Trials
    Research areas: Genetic Epidemiology, Project Management, Computational Modeling
    
    •Adriano Henney
    Organisation: OBSIDIAN BIOMEDICAL CONSULTING LTD, Ploughmans Way 34, SK10 2UN MACCLESFIELD, UK
    Project title: A Strategy for In-Silico Clinical Trials
    Research areas: Cardiovascular Genetics, Vascular Biology, Systems Biology, Drug Discovery
    
    •Sandra Visser
    Organisation: ASTRAZENECA AB, Vastra Maelarhamnen, 151 85 Sodertaelje, SE
    Project title: Innovative Modelling for Pharmacological Advances through Collaborative Training
    Research areas: Quantitative Pharmacology, Translational Pharmacokinetic-Pharmacodynamic Modeling, Drug Discovery
    
    •Peter Hedges
    Organisation: THE UNIVERSITY OF WARWICK, Kirby Corner Road - University House, CV4 8UW Coventry, UK
    Project title: Innovative Modelling for Pharmacological Advances through Collaborative Training
    Research areas: Research Evaluation, Research Integrity, Governance
    
    •Daniel Courtois
    Organisation: INSTITUT DE RECHERCHES INTERNATIONALES SERVIER IRIS, RUE CARNOT 50, 92284 Courbevoie, FR
    Project title: Drug Disease Model Resources
    Research areas: Medicinal Chemistry, Drug Development, Computational Modeling
    
    •Iñigo Uriarte-Pueyo
    Organisation: UNIVERSIDAD DE NAVARRA, CAMPUS UNIVERSITARIO EDIFICIO CENTRAL, 31080 Pamplona, ES
    Project title: Drug Disease Model Resources
    Research areas: Pharmaceutical Technology, Project Management, Computational Modeling
    
    •Ton Brouwer
    Organisation: UNIVERSITEIT LEIDEN, RAPENBURG 70, 2311 EZ Leiden, NL
    Project title: Drug Disease Model Resources
    Research areas: Criminalistics, Computational Modeling, Bioinformatics
    
    •Heike Wachenhausen
    Organisation: NOVARTIS PHARMA AG, LICHTSTRASSE 35, 4056 Basel, CH
    Project title: Drug Disease Model Resources
    Research areas: Regulatory Affairs, Medicinal Products, Medical Devices
    
    •Michael Agur
    Organisation: OPTIMATA LTD, 20 ZICHRON YAA'KOV ST., 6299920 TEL AVIV, IL
    Project title: Drug Disease Model Resources
    Research areas: Computational Modeling, Oncology, Drug Development
    
    •Mark Warburton
    Organisation: CYPROTEX DISCOVERY LIMITED, 114 INNOVATION DRIVE MILTON PARK, OX14 4RZ ABINGDON OXFORDSHIRE, UK
    Project title: Drug Disease Model Resources
    Research areas: Drug Transporter Capabilities, Legal Counsel, Computational Modeling
    
    •Michela Matteoli
    Organisation: CONSIGLIO NAZIONALE DELLE RICERCHE, PIAZZALE ALDO MORO 7, 00185 ROMA, IT
    Project title: Drug Disease Model Resources
    Research areas: Neuroscience, Synapse Dysfunctions, Neurodegenerative Diseases
    
    •Marc Loher
    Organisation: INTERFACE EUROPE, Rue du Trône, 1000 Bruxelles, BE
    Project title: Drug Disease Model Resources
    Research areas: European Research & Innovation, Computational Modeling, Bioinformatics
    
    •Elaine Alison Irving
    Organisation: GLAXOSMITHKLINE RESEARCH AND DEVELOPMENT LTD., Great West Road 980, TW89GS Brentford, UK
    Project title: Drug Disease Model Resources
    Research areas: Drug Development, Clinical Trials, Real World Study Delivery
    
    •Carsten Malmwieck
    Organisation: FREIE UNIVERSITAET BERLIN, KAISERSWERTHER STRASSE 16-18, 14195 Berlin, DE
    Project title: Drug Disease Model Resources
    Research areas: Toxicity Pathway-Based Paradigm, Chemical Safety Assessment, Computational Modeling
    
    •Lutz Harnisch
    Organisation: PFIZER LIMITED, RAMSGATE ROAD, CT13 9NJ SANDWICH, UK
    Project title: Drug Disease Model Resources
    Research areas: Pharmacometrics, Rare Diseases, Computational Modeling
    
    •Olga Krylova
    Organisation: PFIZER LIMITED, RAMSGATE ROAD, CT13 9NJ SANDWICH, UK
    Project title: Drug Disease Model Resources
    Research areas: Business Development, Oncology, Computational Modeling
    
    •Muriel Maurice
    Organisation: Université Paris Diderot-Paris 7, Rue Thomas Mann, F-75205 / 13 Paris, FR
    Project title: Drug Disease Model Resources
    Research areas: Biopolitics, Computational Modeling, Bioinformatics
    
    •Zoe Kelly
    Organisation: CERTARA UK LIMITED, ONE LONDON WALL 6TH FLOOR, EC2Y 5EB London, UK
    Project title: Drug Disease Model Resources
    Research areas: Biomedical Science, Ovarian Cancer, Computational Modeling
    
    •Nicola Carley
    Organisation: Mango Business Solutions Limited, Suite 3 Middlesex House, Rutherford Close, SG1 2EF Stevenage, UK
    Project title: Drug Disease Model Resources
    Research areas: Nutritional Information, Augmented Reality, Computational Modeling
    
    •Eva Lindgren
    Organisation: ASTRAZENECA AB, Vastra Maelarhamnen, 151 85 Sodertaelje, SE
    Project title: Drug Disease Model Resources
    Research areas: Bioinformatics, Chemoinformatics, Computational Modeling
    
    •Ninog Peresse
    Organisation: MERCK KOMMANDITGESELLSCHAFT AUF AKTIEN, FRANKFURTER STRASSE 250, 64293 Darmstadt, DE
    Project title: Drug Disease Model Resources
    Research areas: Healthcare Pipeline, Immunology, Computational Modeling
    
    •Tom Ratcliff
    Organisation: EUROPEAN MOLECULAR BIOLOGY LABORATORY, Meyerhofstrasse 1, 69117 Heidelberg, DE
    Project title: Drug Disease Model Resources
    Research areas: Biological Sciences, Medical Sciences, Computational Modeling
    
    •Jérôme Kalifa
    Organisation: LIXOFT SAS, 8 RUE DE LA RENAISSANCE BATIMENT D, 92160 Antony, FR
    Project title: Drug Disease Model Resources
    Research areas: Digital Signal Processing, Image Processing, Computational Modeling
    
    •Mireille Moulin
    Organisation: INSTITUT NATIONAL DE RECHERCHE EN INFORMATIQUE ET AUTOMATIQUE, DOMAINE DE VOLUCEAU ROCQUENCOURT, 78153 LE CHESNAY CEDEX, FR
    Project title: Drug Disease Model Resources
    Research areas: Informatics, Automation, Computational Modeling
    
    •Jason Hannon
    Organisation: F. HOFFMANN-LA ROCHE AG, GRENZACHERSTRASSE 124, 4070 Basel, CH
    Project title: Drug Disease Model Resources
    Research areas: Therapeutic Innovation, Clinical Practice Guidelines, Computational Modeling
    
    •Jorgen Dirach
    Organisation: NOVO NORDISK A/S, NOVO ALLE 1, 2880 BAGSVAERD, DK
    Project title: Drug Disease Model Resources
    Research areas: Drug Development, Computational Modeling, Bioinformatics
    
    •Gezim Lahu
    Organisation: TAKEDA PHARMACEUTICALS INTERNATIONAL AG, THURGAUERSTRASSE 130, 8152 GLATTPARK, CH
    Project title: Drug Disease Model Resources
    Research areas: Systems Pharmacology, Personalized Medicine, Computational Modeling
    
    •Sigrid Köhne
    Organisation: MARTIN-LUTHER-UNIVERSITAT HALLE-WITTENBERG, UNIVERSITATSPLATZ 10, 6108 Halle, DE
    Project title: Drug Disease Model Resources
    Research areas: Agroecology, Behavioral Sciences, Computational Modeling
    
    •Birgit Steckel-Hamann
    Organisation: ELI LILLY AND COMPANY LTD, LILLY HOUSE BASINGVIEW, RG21 4FA BASINGSTOKE, UK
    Project title: Drug Disease Model Resources
    Research areas: Pharmacology, Cardiometabolic Health, Computational Modeling
    """,
    """
    •Catherine RIVIERE
    Organisation: GRAND EQUIPEMENT NATIONAL DE CALCUL INTENSIF, 6 BIS RUE AUGUSTE VITU, 75015 Paris, FR
    Project title: European Exascale Software Initiative 2: Towards exascale roadmap implementation
    Research areas: High-performance computing (HPC), software development, performance analysis
    
    •Thierry Bidot
    Organisation: NEOVIA, 59 RUE DE L ABONDANCE, 69003 LYON, FR
    Project title: European Exascale Software Initiative 2: Towards exascale roadmap implementation
    Research areas: Numerical analysis, digital and technological R&D, extreme scale scientific computing
    
    •Francesca Arcara
    Organisation: BARCELONA SUPERCOMPUTING CENTER CENTRO NACIONAL DE SUPERCOMPUTACION, CALLE JORDI GIRONA 31, 08034 Barcelona, ES
    Project title: European Exascale Software Initiative 2: Towards exascale roadmap implementation
    Research areas: Project management, supercomputing, HPC applications
    
    •Cathy MORIN
    Organisation: TOTALENERGIES SE, PLACE JEAN MILLIER 2 LA DEFENSE 6, 92400 Courbevoie, FR
    Project title: European Exascale Software Initiative 2: Towards exascale roadmap implementation
    Research areas: Energy efficiency, HPC applications, software development
    
    •Peter Hans Michielse
    Organisation: STICHTING ACADEMISCH REKENCENTRUM AMSTERDAM (SARA), KRUISLAAN 415, 1098 SJ AMSTERDAM, NL
    Project title: European Exascale Software Initiative 2: Towards exascale roadmap implementation
    Research areas: Applied mathematics, computer science, HPC architectures
    
    •Helene Bridie
    Organisation: SURF BV, MOREELSEPARK 48, 3511 EP UTRECHT, NL
    Project title: European Exascale Software Initiative 2: Towards exascale roadmap implementation
    Research areas: HPC software, performance analysis, applications knowledge
    
    •Volker Marx
    Organisation: FORSCHUNGSZENTRUM JULICH GMBH, WILHELM JOHNEN STRASSE, 52428 JULICH, DE
    Project title: European Exascale Software Initiative 2: Towards exascale roadmap implementation
    Research areas: HPC systems, software development, performance optimization
    
    •Inigo YENES
    Organisation: PARTNERSHIP FOR ADVANCED COMPUTING IN EUROPE AISBL, RUE DU TRONE 98, 1050 BRUXELLES, BE
    Project title: European Exascale Software Initiative 2: Towards exascale roadmap implementation
    Research areas: HPC community structuring, synchronization, extreme scale computing
    
    •Mark Parsons
    Organisation: THE UNIVERSITY OF EDINBURGH, OLD COLLEGE, SOUTH BRIDGE, EH8 9YL Edinburgh, UK
    Project title: European Exascale Software Initiative 2: Towards exascale roadmap implementation
    Research areas: High-performance computing, next-generation HPC research, exascale systems
    
    •Vera Kleber
    Organisation: GERMAN RESEARCH SCHOOL FOR SIMULATION SCIENCES GMBH, STETTERNICHER STAATSFORST, 52428 Juelich, DE
    Project title: European Exascale Software Initiative 2: Towards exascale roadmap implementation
    Research areas: Simulation sciences, HPC applications, performance analysis
    """,
    """
    •Olaf Kath
    Organisation: ANSYS MEDINI TECHNOLOGIES AG, DESSAUER STRASSE 28 29, 10963 BERLIN, DE
    Project title: Verification and Testing to Support Functional Safety Standards
    Research areas: Functional safety, ECS architectures, simulation environments, quality assurance metrics
    
    •Gemma Gallego Capella
    Organisation: IDNEO TECHNOLOGIES SL, POLIGONO INDUSTRIAL CAN MITJANS SN, 08232 VIALDECAVALLS BARCELONA, ES
    Project title: Verification and Testing to Support Functional Safety Standards
    Research areas: Functional safety, ECS architectures, simulation environments, quality assurance metrics
    ...
    •Ian Broster
    Organisation: RAPITA SYSTEMS LIMITED, ATLAS HOUSE OSBALDWICK LINK ROAD, YO10 3JB YORK, UK
    Project title: Verification and Testing to Support Functional Safety Standards
    Research areas: Functional safety, ECS architectures, simulation environments, quality assurance metrics
    
    •Marlis Stifter-Lindner
    Organisation: INFINEON TECHNOLOGIES AUSTRIA AG, SIEMENSSTRASSE 2, 9500 Villach, AT
    Project title: Verification and Testing to Support Functional Safety Standards
    Research areas: Functional safety, ECS architectures, simulation environments, quality assurance metrics
    
    •Torbjörn Norlander
    Organisation: E-AAM DRIVELINE SYSTEMS AB, NOHABGATAN 18E, 461 29 TROLLHATTAN, SE
    Project title: Verification and Testing to Support Functional Safety Standards
    Research areas: Functional safety, ECS architectures, simulation environments, quality assurance metrics
    
    •Sibylle Kuster
    Organisation: TECHNISCHE UNIVERSITAET WIEN, KARLSPLATZ 13, 1040 WIEN, AT
    Project title: Verification and Testing to Support Functional Safety Standards
    Research areas: Functional safety, ECS architectures, simulation environments, quality assurance metrics
    
    •Jean Marc Forey
    Organisation: SYNOPSYS SARL, RUE D ARCUEIL 54, 94150 Rungis, FR
    Project title: Verification and Testing to Support Functional Safety Standards
    Research areas: Functional safety, ECS architectures, simulation environments, quality assurance metrics
    
    •Josef Affenzeller
    Organisation: AVL LIST GMBH, HANS-LIST-PLATZ 1, 8020 Graz, AT
    Project title: Verification and Testing to Support Functional Safety Standards
    Research areas: Functional safety, ECS architectures, simulation environments, quality assurance metrics
    
    •Ted Kruse
    Organisation: VOLVO TECHNOLOGY AB, GOTAVERKSGATAN 10, 405 08 GOTEBORG, SE
    Project title: Verification and Testing to Support Functional Safety Standards
    Research areas: Functional safety, ECS architectures, simulation environments, quality assurance metrics
    """,
    """
    •Efstathia Kafentzi
    Organisation: ETHNIKO KAI KAPODISTRIAKO PANEPISTIMIO ATHINON, 6 CHRISTOU LADA STR, 10561 ATHINA, EL
    Project title: Maximising the Exploitation of Linked Open Data In Enterprise and Science
    Research areas: Cryptographic technologies, data management, marine information, urban ecosystems
    
    •Livia Cassai
    Organisation: ISTITUTO NAZIONALE DI GEOFISICA E VULCANOLOGIA, Via di Vigna Murata 605, 00143 Roma, IT
    Project title: Maximising the Exploitation of Linked Open Data In Enterprise and Science
    Research areas: Geophysics, project management, administration
    
    •Fabrice Brito
    Organisation: TERRADUE SRL, VIA RAVENNA 34, 00161 ROMA, IT
    Project title: Maximising the Exploitation of Linked Open Data In Enterprise and Science
    Research areas: Earth Observation, data analytics, business strategy
    
    •Jon Styles
    Organisation: ASSIMILA LIMITED, THE ENTERPRISE CENTRE UNIVERSITY OF READING, EARLE GATE, WHITEKNIGHTS ROAD, RG6 6BU READING BERKSHIRE, UK
    Project title: Maximising the Exploitation of Linked Open Data In Enterprise and Science
    Research areas: Earth observation, environmental research, agriculture, land, and climate risks
    
    •Nina Gerhard
    Organisation: TERRANEA UG (HAFTUNGSBESCHRANKT) GMBH, BAHNHOFSTRASSE 120, 82269 Geltendorf, DE
    Project title: Maximising the Exploitation of Linked Open Data In Enterprise and Science
    Research areas: Snow cover analysis, landslide prone areas, disaster management
    
    •Han Wensink
    Organisation: BMT ARGOSS BV, Voorsterweg 28, 8316PT Marknesse, NL
    Project title: Maximising the Exploitation of Linked Open Data In Enterprise and Science
    Research areas: Marine insight, waves, wind, tides, feasibility studies
    
    •Ugo Di Giammatteo
    Organisation: ADVANCED COMPUTER SYSTEMS A.C.S. SRL, VIA DELLA BUFALOTTA 378, 00139 ROMA, IT
    Project title: Maximising the Exploitation of Linked Open Data In Enterprise and Science
    Research areas: Business development, computer science, automation
    
    •Francisco Batlle
    Organisation: HYDROMODEL HOST SL, CALLE VALLSECA 5B, 08173 SANT CUGAT DEL VALLES BARCELONA, ES
    Project title: Maximising the Exploitation of Linked Open Data In Enterprise and Science
    Research areas: Groundwater hydrology, water resources management, numerical models
    
    •Teresa Malhoa
    Organisation: INSTITUTO SUPERIOR TECNICO, AVENIDA ROVISCO PAIS 1, 1049 001 LISBOA, PT
    Project title: Maximising the Exploitation of Linked Open Data In Enterprise and Science
    Research areas: Project management, scientific and technological training
    
    •Conrad Bielski
    Organisation: EOXPLORE UG (HAFTUNGSBESCHRANKT) GMBH, GAUGRAFENSTRASSE 8, 82041 Oberhaching, DE
    Project title: Maximising the Exploitation of Linked Open Data In Enterprise and Science
    Research areas: Earth Observation, geospatial data, image processing
    """,
    """
    •Nadezda Patoprsta
    Organisation: Ministry of Interior of the Slovak Republic, Pribinova 2, 81272 Bratislava, SK
    Project title: Coordinating National Research Programmes and Policies on Security at Major Events in Europe
    Research areas: Internal administration, territorial and administrative structuring, security research coordination
    
    •Zoran Music
    Organisation: Policijska uprava Maribor, Maistrova ulica, 2000 MARIBOR, SI
    Project title: Coordinating National Research Programmes and Policies on Security at Major Events in Europe
    Research areas: Security policies, law enforcement coordination
    
    •Christian Preischl
    Organisation: BUNDESMINISTERIUM FUER INNERES, Herrengasse 7, 1010 Wien, AT
    Project title: Coordinating National Research Programmes and Policies on Security at Major Events in Europe
    Research areas: Security planning, law enforcement operations
    
    •Lena Tysk
    Organisation: RIKSPOLISSTYRELSEN - SWEDISH NATIONAL POLICE BOARD, Polhemsgatan, 10226 Stockholm, SE
    Project title: Coordinating National Research Programmes and Policies on Security at Major Events in Europe
    Research areas: Police affairs, public order management
    
    •Ivar Prits
    Organisation: MINISTRY OF JUSTICE, TONISMAAGI 5A, 15191 TALLINN, EE
    Project title: Coordinating National Research Programmes and Policies on Security at Major Events in Europe
    Research areas: Forensic science, law enforcement coordination
    
    •Esko Ruokonen
    Organisation: SISAASIAINMINISTERIO, Saastopankinranta, 2A, 00023 HELSINKI, FI
    Project title: Coordinating National Research Programmes and Policies on Security at Major Events in Europe
    Research areas: Police services, security policies
    
    •Andreas Panayiotou
    Organisation: Cyprus police, Presidential Palace Street, 1081 Nicosia, CY
    Project title: Coordinating National Research Programmes and Policies on Security at Major Events in Europe
    Research areas: Law enforcement, security coordination
    
    •Paulo Gomes
    Organisation: MINISTERIO DA ADMINISTRACAO INTERNA, Rua Capelo 11, 1249-110 Lisboa, PT
    Project title: Coordinating National Research Programmes and Policies on Security at Major Events in Europe
    Research areas: Police administration, security policies
    
    •Jonathan Brady
    Organisation: MAYOR'S OFFICE FOR POLICING AND CRIME, CITY HALL, MORE LONDON, SE1 2AA LONDON, UK
    Project title: Coordinating National Research Programmes and Policies on Security at Major Events in Europe
    Research areas: Policing and crime prevention, security coordination
    
    •Henrik Arne Mai
    Organisation: National Police Department, Polititorvet, DK-1780 Copenhagen, DK
    Project title: Coordinating National Research Programmes and Policies on Security at Major Events in Europe
    Research areas: Police operations, security policies
    """
]
